...
public final class UStringsKt {
    ...
    public static final String m203toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m205toStringolVBNx4(short s, int i) {
    ...
    public static final String m204toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m202toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m666unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m926unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m744unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m822unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m744unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m693constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m611boximpl(UByte.m617constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m744unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m693constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m871boximpl(UShort.m877constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m693constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m946uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int r3 = UInt.m693constructorimpl(i2 * r5);
            int r8 = UInt.m693constructorimpl(UInt.m693constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m771constructorimpl((long) i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m948ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m771constructorimpl(j2 * r9);
            long r4 = ULong.m771constructorimpl(ULong.m771constructorimpl(((long) UInt.m693constructorimpl(digitOf)) & 4294967295L) + r11);
