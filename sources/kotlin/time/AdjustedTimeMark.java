...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m214minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m358minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m213getAdjustmentUwyO8pc() {
    ...
    public long m212elapsedNowUwyO8pc() {
        return Duration.m255minusLRDsOJo(this.mark.m355elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m215plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m256plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
