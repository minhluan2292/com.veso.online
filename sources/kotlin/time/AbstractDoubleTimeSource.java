...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark implements TimeMark {
        ...
        public TimeMark m207minusLRDsOJo(long j) {
            return TimeMark.DefaultImpls.m358minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m206elapsedNowUwyO8pc() {
            return Duration.m255minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public TimeMark m208plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m256plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }
    }

    public TimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m322getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
