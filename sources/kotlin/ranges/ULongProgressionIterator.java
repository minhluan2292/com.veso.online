...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        this.hasNext = z;
        this.step = ULong.m771constructorimpl(j3);
        this.next = !this.hasNext ? j2 : j;
    }

    public /* bridge */ /* synthetic */ Object next() {
        return ULong.m765boximpl(m142nextsVKNKU());
    }
    ...
    public long m142nextsVKNKU() {
        long j = this.next;
        if (j != this.finalElement) {
            this.next = ULong.m771constructorimpl(this.step + j);
