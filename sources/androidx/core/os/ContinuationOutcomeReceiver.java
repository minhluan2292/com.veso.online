...
final class ContinuationOutcomeReceiver<R, E extends Throwable> extends AtomicBoolean implements OutcomeReceiver<R, E> {
    ...
    public void onResult(R r) {
        if (compareAndSet(false, true)) {
            ...
            continuation2.resumeWith(Result.m599constructorimpl(r));
        }
    }

    public void onError(E e) {
        Intrinsics.checkNotNullParameter(e, Constants.IPC_BUNDLE_KEY_SEND_ERROR);
        if (compareAndSet(false, true)) {
            Continuation<R> continuation2 = this.continuation;
            Result.Companion companion = Result.Companion;
            continuation2.resumeWith(Result.m599constructorimpl(ResultKt.createFailure(e)));
        }
    }
