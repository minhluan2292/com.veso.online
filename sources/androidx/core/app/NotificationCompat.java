...
public class NotificationCompat {
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        boolean z5 = z2;
        if (Build.VERSION.SDK_INT < 23) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, isContextual, z5);
        }
        ...
        return new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, isContextual, z5);
    }
