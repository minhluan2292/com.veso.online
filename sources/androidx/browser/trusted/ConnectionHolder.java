...
class ConnectionHolder implements ServiceConnection {
    ...
    public /* synthetic */ Object m9lambda$getServiceWrapper$0$androidxbrowsertrustedConnectionHolder(CallbackToFutureAdapter.Completer completer) throws Exception {
        int i = this.mState;
        if (i == 0) {
