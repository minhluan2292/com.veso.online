...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new FragmentActivity$$ExternalSyntheticLambda3(this));
        addOnConfigurationChangedListener(new FragmentActivity$$ExternalSyntheticLambda2(this));
        addOnNewIntentListener(new FragmentActivity$$ExternalSyntheticLambda1(this));
    ...
    public /* synthetic */ Bundle m38lambda$init$0$androidxfragmentappFragmentActivity() {
    ...
    public /* synthetic */ void m39lambda$init$1$androidxfragmentappFragmentActivity(Configuration configuration) {
        this.mFragments.noteStateNotSaved();
    }

    /* renamed from: lambda$init$2$androidx-fragment-app-FragmentActivity  reason: not valid java name */
    public /* synthetic */ void m40lambda$init$2$androidxfragmentappFragmentActivity(Intent intent) {
        this.mFragments.noteStateNotSaved();
    }

    /* renamed from: lambda$init$3$androidx-fragment-app-FragmentActivity  reason: not valid java name */
    public /* synthetic */ void m41lambda$init$3$androidxfragmentappFragmentActivity(Context context) {
