...
public final class SavedStateHandle {
    ...
    public static final Bundle m58savedStateProvider$lambda0(SavedStateHandle savedStateHandle) {
    ...
    public final void setSavedStateProvider(String str, SavedStateRegistry.SavedStateProvider savedStateProvider2) {
        Intrinsics.checkNotNullParameter(str, "key");
        Intrinsics.checkNotNullParameter(savedStateProvider2, IronSourceConstants.EVENTS_PROVIDER);
