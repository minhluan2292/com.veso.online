...
public final class NavigationUI {
    ...
    public static final void m76setupWithNavController$lambda1(NavController navController, AppBarConfiguration appBarConfiguration, View view) {
        Intrinsics.checkNotNullParameter(navController, "$navController");
        Intrinsics.checkNotNullParameter(appBarConfiguration, "$configuration");
    ...
    public static final void m77setupWithNavController$lambda2(NavController navController, AppBarConfiguration appBarConfiguration, View view) {
        Intrinsics.checkNotNullParameter(navController, "$navController");
        Intrinsics.checkNotNullParameter(appBarConfiguration, "$configuration");
        navigateUp(navController, appBarConfiguration);
    }
    ...
    public static final boolean m78setupWithNavController$lambda3(NavController navController, NavigationView navigationView, MenuItem menuItem) {
        Intrinsics.checkNotNullParameter(navController, "$navController");
        Intrinsics.checkNotNullParameter(navigationView, "$navigationView");
        Intrinsics.checkNotNullParameter(menuItem, "item");
    ...
    public static final boolean m79setupWithNavController$lambda5(NavController navController, boolean z, NavigationView navigationView, MenuItem menuItem) {
        Intrinsics.checkNotNullParameter(navController, "$navController");
        Intrinsics.checkNotNullParameter(navigationView, "$navigationView");
        Intrinsics.checkNotNullParameter(menuItem, "item");
    ...
    public static final boolean m80setupWithNavController$lambda6(NavController navController, MenuItem menuItem) {
        Intrinsics.checkNotNullParameter(navController, "$navController");
        Intrinsics.checkNotNullParameter(menuItem, "item");
    ...
    public static final boolean m81setupWithNavController$lambda8(NavController navController, boolean z, MenuItem menuItem) {
        Intrinsics.checkNotNullParameter(navController, "$navController");
        Intrinsics.checkNotNullParameter(menuItem, "item");
