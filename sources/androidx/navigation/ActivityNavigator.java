...
public class ActivityNavigator extends Navigator<Destination> {
    ...
    public static class Destination extends NavDestination {
        ...
        public boolean equals(Object obj) {
            ...
            Intent intent2 = this.intent;
            if (!(intent2 != null ? intent2.filterEquals(((Destination) obj).intent) : ((Destination) obj).intent == null) || !Intrinsics.areEqual((Object) this.dataPattern, (Object) ((Destination) obj).dataPattern)) {
                return false;
            }
            return true;
        }
