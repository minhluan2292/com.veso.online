...
public final class Navigation {
    ...
    public static final void m70createNavigateOnClickListener$lambda0(int i, Bundle bundle, View view) {
    ...
    public static final void m71createNavigateOnClickListener$lambda1(NavDirections navDirections, View view) {
        Intrinsics.checkNotNullParameter(navDirections, "$directions");
        Intrinsics.checkNotNullExpressionValue(view, "view");
