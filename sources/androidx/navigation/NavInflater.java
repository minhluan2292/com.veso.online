...
public final class NavInflater {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:15:0x005e A[Catch:{ Exception -> 0x0068, all -> 0x0066 }] */
    /* JADX WARNING: Removed duplicated region for block: B:7:0x0022 A[Catch:{ Exception -> 0x0068, all -> 0x0066 }] */
    ...
    public final androidx.navigation.NavGraph inflate(int r7) {
        ...
        L_0x0016:
            int r3 = r1.next()     // Catch:{ Exception -> 0x0068 }
            r4 = 2
        ...
        L_0x0020:
            ...
            java.lang.String r3 = r1.getName()     // Catch:{ Exception -> 0x0068 }
            java.lang.String r4 = "res"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r4)     // Catch:{ Exception -> 0x0068 }
            java.lang.String r4 = "attrs"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r4)     // Catch:{ Exception -> 0x0068 }
            androidx.navigation.NavDestination r2 = r6.inflate(r0, r1, r2, r7)     // Catch:{ Exception -> 0x0068 }
            boolean r4 = r2 instanceof androidx.navigation.NavGraph     // Catch:{ Exception -> 0x0068 }
            if (r4 == 0) goto L_0x003e
            androidx.navigation.NavGraph r2 = (androidx.navigation.NavGraph) r2     // Catch:{ Exception -> 0x0068 }
            r1.close()
            return r2
        L_0x003e:
            ...
            r2.append(r4)     // Catch:{ Exception -> 0x0068 }
            ...
            java.lang.IllegalArgumentException r3 = new java.lang.IllegalArgumentException     // Catch:{ Exception -> 0x0068 }
            java.lang.String r2 = r2.toString()     // Catch:{ Exception -> 0x0068 }
            r3.<init>(r2)     // Catch:{ Exception -> 0x0068 }
            throw r3     // Catch:{ Exception -> 0x0068 }
        L_0x005e:
            org.xmlpull.v1.XmlPullParserException r2 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ Exception -> 0x0068 }
        ...
        L_0x0068:
            ...
            java.lang.String r7 = r0.getResourceName(r7)     // Catch:{ all -> 0x0066 }
            r4.append(r7)     // Catch:{ all -> 0x0066 }
            java.lang.String r7 = " line "
            r4.append(r7)     // Catch:{ all -> 0x0066 }
            int r7 = r1.getLineNumber()     // Catch:{ all -> 0x0066 }
            r4.append(r7)     // Catch:{ all -> 0x0066 }
            java.lang.String r7 = r4.toString()     // Catch:{ all -> 0x0066 }
            java.lang.Throwable r2 = (java.lang.Throwable) r2     // Catch:{ all -> 0x0066 }
            r3.<init>(r7, r2)     // Catch:{ all -> 0x0066 }
