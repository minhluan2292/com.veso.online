...
public final class b implements c, e, f, a, com.ironsource.sdk.j.a.b, c, d {
    ...
    private void b(Context context) {
        try {
            ...
            this.a = new g(context, this.l, this.i, this.e, com.ironsource.environment.e.a.a, debugMode, this.m.getDataManagerConfig());
            Logger.enableLogging(debugMode);
            Logger.i("IronSourceAdsPublisherAgent", "C'tor");
            a(context, networkConfiguration);
            this.j = new com.ironsource.sdk.service.c();
            com.ironsource.mediationsdk.adunit.a.a.a("sdkv", (Object) "5.119");
            this.j.a();
            this.j.a(context);
            this.j.b();
            this.j.c();
    ...
    private void d(final com.ironsource.sdk.b bVar, final Map<String, String> map) {
        ...
        this.a.a((Runnable) new Runnable() {
            public final void run() {
                ...
                hashMap.put("apiVersion", XosoConfig.REGION_ID_NORTH);
                String str3 = "0";
                hashMap.put("width", bVar.e != null ? Integer.toString(bVar.e.a) : str3);
                if (bVar.e != null) {
                    str3 = Integer.toString(bVar.e.b);
                }
                hashMap.put("height", str3);
                hashMap.put(Constants.ScionAnalytics.PARAM_LABEL, bVar.e != null ? bVar.e.c : "");
                ...
                com.ironsource.sdk.a.a aVar = new com.ironsource.sdk.a.a();
                com.ironsource.sdk.a.a a2 = aVar.a("isbiddinginstance", Boolean.valueOf(bVar.d)).a("isoneflow", Boolean.valueOf(bVar.i)).a("demandsourcename", bVar.c).a("producttype", com.ironsource.sdk.d.a(bVar));
                ...
                com.ironsource.sdk.a.d.a(com.ironsource.sdk.a.f.g, (Map<String, Object>) aVar.a);
                if (eVar == d.e.Banner) {
