...
public class ControllerActivity extends Activity implements w, g {
    private static final String a = "ControllerActivity";
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(this.i) && d.e.OfferWall.toString().equalsIgnoreCase(this.i)) {
                if (bundle != null) {
                    b bVar = (b) bundle.getParcelable("state");
                    if (bVar != null) {
                        this.m = bVar;
                        this.e.a(bVar);
                    }
    ...
    public void onPause() {
        ...
        com.ironsource.environment.e.a.a.b(new Runnable((AudioManager) getSystemService("audio")) {
