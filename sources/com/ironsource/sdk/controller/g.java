...
public class g implements e, m {
    ...
    public g(Context context, c cVar, com.ironsource.sdk.service.d dVar, j jVar, a aVar, int i, JSONObject jSONObject) {
        this.g = aVar;
        ...
        b((Runnable) new Runnable() {
            public final void run() {
                try {
                    g gVar = g.this;
                    m unused = gVar.a = g.a(gVar, context2, cVar2, dVar2, jVar2, i2, jSONObject2);
                    g.this.a.h();
                } catch (Exception e2) {
    ...
    static /* synthetic */ x a(g gVar, Context context, c cVar, com.ironsource.sdk.service.d dVar, j jVar, int i, JSONObject jSONObject) {
