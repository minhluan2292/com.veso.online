...
public class IronSourceUtils {
    ...
    private static final String SDK_VERSION = "7.2.5";
    ...
    public static boolean getFirstSession(Context context) {
        if (mFirstSession == null) {
            mFirstSession = Boolean.valueOf(!H.b(context));
        }
    ...
    public static JSONObject getProviderAdditionalData(C0017b bVar) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(PROVIDER_PRIORITY, bVar.n);
            jSONObject.put(IronSourceConstants.EVENTS_SUB_PROVIDER_ID, bVar.f);
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER, !TextUtils.isEmpty(bVar.g) ? bVar.g : bVar.j());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER_SDK_VERSION, bVar.b.getCoreSDKVersion());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER_ADAPTER_VERSION, bVar.b.getVersion());
        } catch (Exception e) {
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.NATIVE;
    ...
    public static JSONObject getProviderAdditionalData(C0032q qVar) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(IronSourceConstants.EVENTS_SUB_PROVIDER_ID, qVar.b.getSubProviderId());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER, !TextUtils.isEmpty(qVar.b.getAdSourceNameForEvents()) ? qVar.b.getAdSourceNameForEvents() : qVar.a());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER_SDK_VERSION, qVar.a.getCoreSDKVersion());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER_ADAPTER_VERSION, qVar.a.getVersion());
            jSONObject.put(PROVIDER_PRIORITY, qVar.f);
        } catch (Exception e) {
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.NATIVE;
            logger.logException(ironSourceTag, "IronSourceUtils:getProviderAdditionalData(adapter: " + qVar.a() + ")", e);
        }
        return jSONObject;
    }
    ...
    public static String getTransId(long j, String str) {
        return getSHA256(String.format("%s%s%s", new Object[]{Long.valueOf(j), L.a().j, str}));
    }

    public static String getUserIdForNetworks() {
        String a = e.a().a("userIdType");
        String a2 = e.a().a(DataKeys.USER_ID);
