...
public final class ag extends C0017b implements RewardedVideoSmashListener {
    JSONObject r;
    ...
    ag(NetworkSettings networkSettings, int i) {
    ...
    public void a(int i, Object[][] objArr) {
        JSONObject providerAdditionalData = IronSourceUtils.getProviderAdditionalData((C0017b) this);
        if (objArr != null) {
            try {
    ...
    public final void g() {
        this.h = 0;
        a(o() ? C0017b.a.AVAILABLE : C0017b.a.NOT_AVAILABLE);
    }
            ...
            this.i.schedule(new TimerTask() {
                public final void run() {
                    synchronized (ag.this) {
                        cancel();
                        if (ag.this.s != null) {
                            String str = "Timeout for " + ag.this.d;
                            ag.this.q.log(IronSourceLogger.IronSourceTag.INTERNAL, str, 0);
                            ag.this.a(C0017b.a.NOT_AVAILABLE);
                            long time = new Date().getTime() - ag.this.u;
                            if (ag.this.t.compareAndSet(true, false)) {
                                ag.this.a(IronSourceConstants.RV_INSTANCE_LOAD_FAILED, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, 1025}, new Object[]{"duration", Long.valueOf(time)}});
                                ag.this.a(IronSourceConstants.RV_INSTANCE_LOAD_FAILED_REASON, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, 1025}, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, str}, new Object[]{"duration", Long.valueOf(time)}});
                            } else {
                                ag.this.a(IronSourceConstants.RV_INSTANCE_AVAILABILITY_FALSE, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, 1025}, new Object[]{"duration", Long.valueOf(time)}});
                            }
                            ag.this.s.a(false, ag.this);
                        }
                    }
                }
            }, (long) (this.x * 1000));
    ...
    public final void n() {
        this.p = null;
        if (this.b != null) {
            if (!(this.a == C0017b.a.CAPPED_PER_DAY || this.a == C0017b.a.CAPPED_PER_SESSION)) {
                this.t.set(true);
    ...
    public final synchronized void onRewardedVideoAvailabilityChanged(boolean r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            r8.e()     // Catch:{ all -> 0x00b2 }
            java.util.concurrent.atomic.AtomicBoolean r0 = r8.t     // Catch:{ all -> 0x00b2 }
            r1 = 0
            r2 = 1
        ...
        L_0x003d:
            r1 = 0
            r8.a(r0, r1)     // Catch:{ all -> 0x00b2 }
        L_0x0041:
            boolean r0 = r8.c()     // Catch:{ all -> 0x00b2 }
            if (r0 == 0) goto L_0x0098
            if (r9 == 0) goto L_0x004f
            com.ironsource.mediationsdk.b$a r0 = r8.a     // Catch:{ all -> 0x00b2 }
            com.ironsource.mediationsdk.b$a r1 = com.ironsource.mediationsdk.C0017b.a.AVAILABLE     // Catch:{ all -> 0x00b2 }
            if (r0 != r1) goto L_0x0057
        L_0x004f:
            if (r9 != 0) goto L_0x0076
            com.ironsource.mediationsdk.b$a r0 = r8.a     // Catch:{ all -> 0x00b2 }
            com.ironsource.mediationsdk.b$a r1 = com.ironsource.mediationsdk.C0017b.a.NOT_AVAILABLE     // Catch:{ all -> 0x00b2 }
            if (r0 == r1) goto L_0x0076
        L_0x0057:
            if (r9 == 0) goto L_0x005c
            com.ironsource.mediationsdk.b$a r0 = com.ironsource.mediationsdk.C0017b.a.AVAILABLE     // Catch:{ all -> 0x00b2 }
            goto L_0x005e
        L_0x005c:
            com.ironsource.mediationsdk.b$a r0 = com.ironsource.mediationsdk.C0017b.a.NOT_AVAILABLE     // Catch:{ all -> 0x00b2 }
        L_0x005e:
            r8.a(r0)     // Catch:{ all -> 0x00b2 }
            ...
            r8.o = r0     // Catch:{ all -> 0x00b2 }
        L_0x006d:
            com.ironsource.mediationsdk.sdk.l r0 = r8.s     // Catch:{ all -> 0x00b2 }
            if (r0 == 0) goto L_0x00b0
            r0.a((boolean) r9, (com.ironsource.mediationsdk.ag) r8)     // Catch:{ all -> 0x00b2 }
            monitor-exit(r8)
            return
        L_0x0076:
            ...
            java.lang.String r2 = r8.d     // Catch:{ all -> 0x00b2 }
        ...
        L_0x0098:
            ...
            r0.<init>()     // Catch:{ all -> 0x00b2 }
            java.lang.String r1 = r8.d     // Catch:{ all -> 0x00b2 }
        ...
        L_0x00b2:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.ag.onRewardedVideoAvailabilityChanged(boolean):void");
    }
