...
public final class C0019d {
    private static final C0019d d = new C0019d();
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.C0019d.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public final com.ironsource.mediationsdk.AbstractAdapter a(com.ironsource.mediationsdk.model.NetworkSettings r7, org.json.JSONObject r8, boolean r9, boolean r10) {
        ...
        L_0x0115:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.C0019d.a(com.ironsource.mediationsdk.model.NetworkSettings, org.json.JSONObject, boolean, boolean):com.ironsource.mediationsdk.AbstractAdapter");
    }
    ...
    public final AdapterBaseInterface a(NetworkSettings networkSettings, IronSource.AD_UNIT ad_unit) {
        ...
        if (this.g.containsKey(b2)) {
            ...
            if (adapterBaseInterface instanceof R) {
                ((R) adapterBaseInterface).a = ad_unit;
            }
        ...
        if (a2 != null || networkSettings.isCustomNetwork()) {
            this.g.put(b2, new AdapterBaseWrapper(a2, networkSettings));
            return a2;
        }
        ...
        if (a3 != null) {
            R r = new R(a3, networkSettings, ad_unit);
            this.g.put(b2, new AdapterBaseWrapper(r, networkSettings));
            return r;
        }
