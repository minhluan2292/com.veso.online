...
public class ServerURL {
    ...
    public static String getCPVProvidersURL(Context context, String str, String str2, String str3, String str4, boolean z, Vector<Pair<String, String>> vector, boolean z2) {
        ...
        if (z) {
            vector2.add(new Pair(REWARDED_VIDEO_MANUAL_MODE, z ? XosoConfig.REGION_ID_SOUTH : "0"));
        }
        ...
        ConcurrentHashMap<String, List<String>> d = a.a().d();
        ...
        if (z2) {
            vector2.add(new Pair("isDemandOnly", XosoConfig.REGION_ID_SOUTH));
        }
