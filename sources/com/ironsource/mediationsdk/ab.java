...
public final class ab extends ac implements RewardedVideoSmashListener {
    ...
    private void a(int i, Object[][] objArr, boolean z2) {
        ...
        if (jSONObject != null && jSONObject.length() > 0) {
            o2.put(IronSourceConstants.EVENTS_GENERIC_PARAMS, this.u);
        }
        if (z2 && (placement = this.r) != null && !TextUtils.isEmpty(placement.getPlacementName())) {
            o2.put("placement", this.r.getPlacementName());
        }
        if (b(i)) {
            h.d();
            h.a(o2, this.w, this.x);
        }
        ...
        if (objArr != null) {
            try {
                ...
                IronSourceLoggerManager.getLogger().log(IronSourceLogger.IronSourceTag.INTERNAL, l() + " smash: RV sendMediationEvent " + Log.getStackTraceString(e), 3);
            }
        }
                ...
                timer.schedule(new TimerTask() {
                    public final void run() {
                        ...
                        synchronized (ab.this.D) {
                            if (ab.this.a != a.LOAD_IN_PROGRESS) {
                                if (ab.this.a != a.INIT_IN_PROGRESS) {
                                    i = 0;
                                    z = false;
                                }
                            }
                        ...
                        ab.this.a(str2);
                        if (z) {
                            ab.this.b(IronSourceConstants.RV_INSTANCE_LOAD_FAILED, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(i)}, new Object[]{"duration", Long.valueOf(ab.this.u())}});
                            ab.this.b(IronSourceConstants.RV_INSTANCE_LOAD_FAILED_REASON, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(i)}, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, str2}, new Object[]{"duration", Long.valueOf(ab.this.u())}});
                            aa e = ab.this.j;
                            ab abVar = ab.this;
                            e.b(abVar, abVar.t);
                            return;
                        }
                        ab.this.b(IronSourceConstants.RV_INSTANCE_AVAILABILITY_FALSE, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, 1025}, new Object[]{"duration", Long.valueOf(ab.this.u())}, new Object[]{IronSourceConstants.EVENTS_EXT1, ab.this.a.name()}});
                    }
                }, (long) (this.l * 1000));
            }
    ...
    public final boolean c() {
        return h() ? this.b && this.a == a.LOADED && r() : r();
    }
    ...
    public final void onRewardedVideoAdClosed() {
        /*
            ...
            monitor-enter(r0)
            com.ironsource.mediationsdk.ab$a r1 = r12.a     // Catch:{ all -> 0x0077 }
            com.ironsource.mediationsdk.ab$a r2 = com.ironsource.mediationsdk.ab.a.SHOW_IN_PROGRESS     // Catch:{ all -> 0x0077 }
            r3 = 0
            ...
            com.ironsource.mediationsdk.ab$a r5 = r12.a     // Catch:{ all -> 0x0077 }
            ...
            return
        L_0x004b:
            com.ironsource.mediationsdk.ab$a r1 = com.ironsource.mediationsdk.ab.a.NOT_LOADED     // Catch:{ all -> 0x0077 }
            r12.a((com.ironsource.mediationsdk.ab.a) r1)     // Catch:{ all -> 0x0077 }
            monitor-exit(r0)     // Catch:{ all -> 0x0077 }
            com.ironsource.mediationsdk.aa r0 = r12.j
            r0.b(r12)
            boolean r0 = r12.p
        ...
        L_0x0077:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.ab.onRewardedVideoAdClosed():void");
    }
    ...
    public final void onRewardedVideoAdRewarded() {
        ...
        if (placement != null) {
            ...
            o2.put(IronSourceConstants.EVENTS_REWARD_NAME, this.r.getRewardName());
            o2.put(IronSourceConstants.EVENTS_REWARD_AMOUNT, Integer.valueOf(this.r.getRewardAmount()));
        }
    ...
    public final void onRewardedVideoAvailabilityChanged(boolean z2) {
        ...
        if (!z3) {
            t();
            b(z2 ? 1002 : IronSourceConstants.RV_INSTANCE_LOAD_FAILED, new Object[][]{new Object[]{"duration", Long.valueOf(u())}});
            if (this.q) {
                this.q = false;
            ...
            b(IronSourceConstants.RV_INSTANCE_AVAILABILITY_FALSE, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceError.ERROR_RV_LOAD_UNEXPECTED_CALLBACK)}, new Object[]{"duration", Long.valueOf(u())}, new Object[]{IronSourceConstants.EVENTS_EXT1, this.a.name()}});
        }
    }
