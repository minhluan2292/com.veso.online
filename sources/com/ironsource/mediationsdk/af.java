...
final class af extends C0016a implements j, C0018c, l, d {
    i m;
    boolean n = false;
    int o;
    B p;
    ...
    private List<C0017b.a> v = Arrays.asList(new C0017b.a[]{C0017b.a.INIT_FAILED, C0017b.a.CAPPED_PER_SESSION, C0017b.a.EXHAUSTED, C0017b.a.CAPPED_PER_DAY});
    ...
    private void a(int i, C0017b bVar, Object[][] objArr) {
        ...
        h.d().b(new c(i, providerAdditionalData));
    }
    ...
    private void a(int i, Object[][] objArr) {
        ...
        h.d().b(new c(i, mediationAdditionalData));
    }

    private synchronized void a(C0017b bVar, int i) {
        Object[][] objArr;
        ...
        if (this.t != null) {
            if (this.n) {
                a(((ag) bVar).v, true, this.t.getPlacementId());
                int placementId = this.t.getPlacementId();
                int i2 = 0;
                while (i2 < i && i2 < this.c.size()) {
                    if (!this.v.contains(((C0017b) this.c.get(i2)).a)) {
                        a(((ag) this.c.get(i2)).v, false, placementId);
                    }
                    i2++;
                }
            }
            ...
            while (i3 < this.c.size() && i3 < i) {
                C0017b bVar2 = (C0017b) this.c.get(i3);
                if (bVar2.a == C0017b.a.NOT_AVAILABLE || bVar2.a == C0017b.a.NEEDS_RELOAD) {
        ...
        ag agVar = (ag) bVar;
        if (agVar.b != null) {
            agVar.q.log(IronSourceLogger.IronSourceTag.INTERNAL, agVar.d + ":showRewardedVideo()", 1);
            agVar.d();
            agVar.b.showRewardedVideo(agVar.r, agVar);
        }
    }
    ...
    private synchronized void a(java.util.Map<java.lang.String, java.lang.Object> r3) {
        /*
            ...
            com.ironsource.mediationsdk.ag r3 = (com.ironsource.mediationsdk.ag) r3     // Catch:{ all -> 0x004a }
        ...
        L_0x004a:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.af.a(java.util.Map):void");
    }
    ...
    private AbstractAdapter f() {
        ...
        for (int i2 = 0; i2 < this.c.size() && abstractAdapter == null; i2++) {
            if (((C0017b) this.c.get(i2)).a == C0017b.a.AVAILABLE || ((C0017b) this.c.get(i2)).a == C0017b.a.INITIATED) {
                i++;
                if (i >= this.b) {
                    break;
                }
            } else if (((C0017b) this.c.get(i2)).a == C0017b.a.NOT_INITIATED && (abstractAdapter = h((ag) this.c.get(i2))) == null) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized com.ironsource.mediationsdk.AbstractAdapter h(com.ironsource.mediationsdk.ag r10) {
        /*
            r9 = this;
            monitor-enter(r9)
            ...
            com.ironsource.mediationsdk.d r0 = com.ironsource.mediationsdk.C0019d.a()     // Catch:{ all -> 0x00d7 }
        ...
        L_0x0057:
            ...
            com.ironsource.mediationsdk.b$a r2 = com.ironsource.mediationsdk.C0017b.a.INITIATED     // Catch:{ all -> 0x00d7 }
            r10.a(r2)     // Catch:{ all -> 0x00d7 }
            r9.b(r10)     // Catch:{ all -> 0x00d7 }
            r2 = 1001(0x3e9, float:1.403E-42)
            r9.a((int) r2, (com.ironsource.mediationsdk.C0017b) r10, (java.lang.Object[][]) r1)     // Catch:{ all -> 0x00d7 }
        ...
        L_0x00a9:
            ...
            com.ironsource.mediationsdk.b$a r0 = com.ironsource.mediationsdk.C0017b.a.INIT_FAILED     // Catch:{ all -> 0x00d7 }
        ...
        L_0x00d7:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.af.h(com.ironsource.mediationsdk.ag):com.ironsource.mediationsdk.AbstractAdapter");
    }
    ...
    private synchronized boolean h() {
        ...
        while (it.hasNext()) {
            ...
            if (bVar.a == C0017b.a.INIT_FAILED || bVar.a == C0017b.a.CAPPED_PER_DAY || bVar.a == C0017b.a.CAPPED_PER_SESSION || bVar.a == C0017b.a.NOT_AVAILABLE || bVar.a == C0017b.a.NEEDS_RELOAD || bVar.a == C0017b.a.EXHAUSTED) {
                i++;
            }
        }
    ...
    private synchronized boolean i() {
        ...
        L_0x0007:
            ...
            com.ironsource.mediationsdk.b r1 = (com.ironsource.mediationsdk.C0017b) r1     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r2 = r1.a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0017b.a.NOT_AVAILABLE     // Catch:{ all -> 0x003c }
            if (r2 == r3) goto L_0x0037
            com.ironsource.mediationsdk.b$a r2 = r1.a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0017b.a.NEEDS_RELOAD     // Catch:{ all -> 0x003c }
            if (r2 == r3) goto L_0x0037
            com.ironsource.mediationsdk.b$a r2 = r1.a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0017b.a.AVAILABLE     // Catch:{ all -> 0x003c }
            if (r2 == r3) goto L_0x0037
            com.ironsource.mediationsdk.b$a r2 = r1.a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0017b.a.INITIATED     // Catch:{ all -> 0x003c }
            if (r2 == r3) goto L_0x0037
            com.ironsource.mediationsdk.b$a r2 = r1.a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0017b.a.INIT_PENDING     // Catch:{ all -> 0x003c }
            if (r2 == r3) goto L_0x0037
            com.ironsource.mediationsdk.b$a r1 = r1.a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r2 = com.ironsource.mediationsdk.C0017b.a.LOAD_PENDING     // Catch:{ all -> 0x003c }
        ...
        L_0x003c:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.af.i():boolean");
    }
    ...
    private synchronized void l() {
        /*
            r9 = this;
            monitor-enter(r9)
            com.ironsource.mediationsdk.AbstractAdapter r0 = r9.f()     // Catch:{ all -> 0x005a }
            if (r0 == 0) goto L_0x0009
            monitor-exit(r9)
            return
        L_0x0009:
            r0 = 4
            com.ironsource.mediationsdk.b$a[] r1 = new com.ironsource.mediationsdk.C0017b.a[r0]     // Catch:{ all -> 0x005a }
            com.ironsource.mediationsdk.b$a r2 = com.ironsource.mediationsdk.C0017b.a.NOT_AVAILABLE     // Catch:{ all -> 0x005a }
            r3 = 0
            r1[r3] = r2     // Catch:{ all -> 0x005a }
            com.ironsource.mediationsdk.b$a r2 = com.ironsource.mediationsdk.C0017b.a.NEEDS_RELOAD     // Catch:{ all -> 0x005a }
            r4 = 1
            r1[r4] = r2     // Catch:{ all -> 0x005a }
            r2 = 2
            com.ironsource.mediationsdk.b$a r4 = com.ironsource.mediationsdk.C0017b.a.CAPPED_PER_SESSION     // Catch:{ all -> 0x005a }
            r1[r2] = r4     // Catch:{ all -> 0x005a }
            r2 = 3
            com.ironsource.mediationsdk.b$a r4 = com.ironsource.mediationsdk.C0017b.a.CAPPED_PER_DAY     // Catch:{ all -> 0x005a }
            r1[r2] = r4     // Catch:{ all -> 0x005a }
            java.util.concurrent.CopyOnWriteArrayList r2 = r9.c     // Catch:{ all -> 0x005a }
        ...
        L_0x0027:
            ...
            com.ironsource.mediationsdk.b r5 = (com.ironsource.mediationsdk.C0017b) r5     // Catch:{ all -> 0x005a }
            r6 = r3
        L_0x0034:
            if (r6 >= r0) goto L_0x0027
            r7 = r1[r6]     // Catch:{ all -> 0x005a }
            com.ironsource.mediationsdk.b$a r8 = r5.a     // Catch:{ all -> 0x005a }
        ...
        L_0x003e:
            ...
            goto L_0x0034
        L_0x0041:
            java.util.concurrent.CopyOnWriteArrayList r0 = r9.c     // Catch:{ all -> 0x005a }
            int r0 = r0.size()     // Catch:{ all -> 0x005a }
            if (r4 >= r0) goto L_0x004e
            r9.m()     // Catch:{ all -> 0x005a }
            monitor-exit(r9)
            return
        L_0x004e:
            boolean r0 = r9.a((boolean) r3, (boolean) r3)     // Catch:{ all -> 0x005a }
            if (r0 == 0) goto L_0x0058
            r0 = 0
            r9.a((java.util.Map<java.lang.String, java.lang.Object>) r0)     // Catch:{ all -> 0x005a }
        L_0x0058:
            monitor-exit(r9)
            return
        L_0x005a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.af.l():void");
    }
    ...
    private synchronized boolean n() {
        ...
        L_0x0007:
            ...
            com.ironsource.mediationsdk.b r1 = (com.ironsource.mediationsdk.C0017b) r1     // Catch:{ all -> 0x002a }
            com.ironsource.mediationsdk.b$a r2 = r1.a     // Catch:{ all -> 0x002a }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0017b.a.NOT_INITIATED     // Catch:{ all -> 0x002a }
            if (r2 == r3) goto L_0x0025
            com.ironsource.mediationsdk.b$a r2 = r1.a     // Catch:{ all -> 0x002a }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0017b.a.INITIATED     // Catch:{ all -> 0x002a }
            if (r2 == r3) goto L_0x0025
            com.ironsource.mediationsdk.b$a r1 = r1.a     // Catch:{ all -> 0x002a }
            com.ironsource.mediationsdk.b$a r2 = com.ironsource.mediationsdk.C0017b.a.AVAILABLE     // Catch:{ all -> 0x002a }
            if (r1 != r2) goto L_0x0007
        L_0x0025:
            r0 = 0
        L_0x0026:
        ...
        L_0x002a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.af.n():boolean");
    }
    ...
    private void o() {
        for (int i = 0; i < this.c.size(); i++) {
            ...
            if (providerTypeForReflection.equalsIgnoreCase(IronSourceConstants.IRONSOURCE_CONFIG_NAME) || providerTypeForReflection.equalsIgnoreCase(IronSourceConstants.SUPERSONIC_CONFIG_NAME)) {
                C0019d.a().a(((C0017b) this.c.get(i)).c, ((C0017b) this.c.get(i)).c.getRewardedVideoSettings(), false, false);
                return;
            }
        }
    }
    ...
    private void q() {
        ...
        while (it.hasNext()) {
            C0017b bVar = (C0017b) it.next();
            if (bVar.a == C0017b.a.AVAILABLE && bVar.l() != null && bVar.l().longValue() < j) {
                j = bVar.l().longValue();
            }
        }
        if (j != Long.MAX_VALUE) {
    ...
    public final void a(ag agVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, agVar.d + ":onRewardedVideoAdOpened()", 1);
        a(1005, (C0017b) agVar, new Object[][]{new Object[]{"placement", p()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(agVar.w)}});
    ...
    public final void a(IronSourceError ironSourceError, ag agVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, agVar.d + ":onRewardedVideoAdShowFailed(" + ironSourceError + ")", 1);
        this.y = false;
        int i = agVar.w;
        a((int) IronSourceConstants.RV_INSTANCE_SHOW_FAILED, (C0017b) agVar, new Object[][]{new Object[]{"placement", p()}, new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(ironSourceError.getErrorCode())}, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, ironSourceError.getErrorMessage()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(i)}});
        b(false);
    ...
    public final synchronized void a(java.lang.String r10) {
        ...
        L_0x0085:
            ...
            com.ironsource.mediationsdk.b r1 = (com.ironsource.mediationsdk.C0017b) r1     // Catch:{ all -> 0x01a1 }
            ...
            com.ironsource.mediationsdk.b$a r5 = com.ironsource.mediationsdk.C0017b.a.AVAILABLE     // Catch:{ all -> 0x01a1 }
            if (r4 != r5) goto L_0x016f
            r4 = r1
            com.ironsource.mediationsdk.ag r4 = (com.ironsource.mediationsdk.ag) r4     // Catch:{ all -> 0x01a1 }
            boolean r4 = r4.o()     // Catch:{ all -> 0x01a1 }
            if (r4 == 0) goto L_0x0120
            r9.a((com.ironsource.mediationsdk.C0017b) r1, (int) r0)     // Catch:{ all -> 0x01a1 }
        ...
        L_0x00d7:
            ...
            com.ironsource.mediationsdk.b$a r10 = com.ironsource.mediationsdk.C0017b.a.CAPPED_PER_SESSION     // Catch:{ all -> 0x01a1 }
            r1.a(r10)     // Catch:{ all -> 0x01a1 }
            r10 = 1401(0x579, float:1.963E-42)
            r0 = 0
            r9.a((int) r10, (com.ironsource.mediationsdk.C0017b) r1, (java.lang.Object[][]) r0)     // Catch:{ all -> 0x01a1 }
            r9.l()     // Catch:{ all -> 0x01a1 }
            monitor-exit(r9)
            return
        L_0x00ed:
            com.ironsource.mediationsdk.utils.e r10 = r9.a     // Catch:{ all -> 0x01a1 }
            boolean r10 = r10.c((com.ironsource.mediationsdk.C0017b) r1)     // Catch:{ all -> 0x01a1 }
            if (r10 == 0) goto L_0x0112
            com.ironsource.mediationsdk.b$a r10 = com.ironsource.mediationsdk.C0017b.a.CAPPED_PER_DAY     // Catch:{ all -> 0x01a1 }
            r1.a(r10)     // Catch:{ all -> 0x01a1 }
        ...
        L_0x0148:
            r4 = r1
            com.ironsource.mediationsdk.ag r4 = (com.ironsource.mediationsdk.ag) r4     // Catch:{ all -> 0x01a1 }
            r9.a((boolean) r6, (com.ironsource.mediationsdk.ag) r4)     // Catch:{ all -> 0x01a1 }
        ...
        L_0x0173:
            ...
            r9.a((com.ironsource.mediationsdk.C0017b) r10, (int) r0)     // Catch:{ all -> 0x01a1 }
            monitor-exit(r9)
            return
        L_0x0186:
        ...
        L_0x01a1:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.af.a(java.lang.String):void");
    }
    ...
    public final synchronized void a(java.lang.String r10, java.lang.String r11) {
        ...
        L_0x0047:
            ...
            com.ironsource.mediationsdk.b r4 = (com.ironsource.mediationsdk.C0017b) r4     // Catch:{ all -> 0x00df }
            com.ironsource.mediationsdk.utils.e r6 = r9.a     // Catch:{ all -> 0x00df }
            boolean r6 = r6.b((com.ironsource.mediationsdk.C0017b) r4)     // Catch:{ all -> 0x00df }
            ...
            r9.a((int) r6, (com.ironsource.mediationsdk.C0017b) r4, (java.lang.Object[][]) r7)     // Catch:{ all -> 0x00df }
        L_0x006f:
            com.ironsource.mediationsdk.utils.e r5 = r9.a     // Catch:{ all -> 0x00df }
            boolean r5 = r5.c((com.ironsource.mediationsdk.C0017b) r4)     // Catch:{ all -> 0x00df }
            if (r5 == 0) goto L_0x0047
            com.ironsource.mediationsdk.b$a r5 = com.ironsource.mediationsdk.C0017b.a.CAPPED_PER_DAY     // Catch:{ all -> 0x00df }
        ...
        L_0x00df:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.af.a(java.lang.String, java.lang.String):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void a(boolean r9, com.ironsource.mediationsdk.ag r10) {
        /*
            r8 = this;
            monitor-enter(r8)
        ...
        L_0x0073:
            ...
            if (r1 != 0) goto L_0x00ba
            com.ironsource.mediationsdk.b$a r1 = com.ironsource.mediationsdk.C0017b.a.CAPPED_PER_SESSION     // Catch:{ all -> 0x00ee }
        ...
        L_0x00ba:
            ...
            boolean r1 = r1.c((com.ironsource.mediationsdk.C0017b) r10)     // Catch:{ all -> 0x00ee }
        ...
        L_0x0117:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.af.a(boolean, com.ironsource.mediationsdk.ag):void");
    }
    ...
    public final synchronized void b() {
        ...
        while (it.hasNext()) {
            ...
            if (bVar.equals(this.e)) {
                bVar.a(C0017b.a.CAPPED_PER_SESSION);
                f();
                return;
            }
        }
    ...
    public final void b(ag agVar) {
        String str;
        this.h.log(IronSourceLogger.IronSourceTag.INTERNAL, agVar.d + ":onRewardedVideoAdClosed()", 1);
        this.y = false;
        ...
        objArr[1] = objArr2;
        objArr[2] = new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(agVar.w)};
        a((int) IronSourceConstants.RV_INSTANCE_CLOSED, (C0017b) agVar, objArr);
        o.a().a(1);
        if (!agVar.b() && !this.a.c((C0017b) agVar)) {
            a(1001, (C0017b) agVar, (Object[][]) null);
        }
        b(false);
    ...
    public final void c(ag agVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, agVar.d + ":onRewardedVideoAdStarted()", 1);
        a((int) IronSourceConstants.RV_INSTANCE_STARTED, (C0017b) agVar, new Object[][]{new Object[]{"placement", p()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(agVar.w)}});
    ...
    public final void c_() {
        ...
        while (it.hasNext()) {
            C0017b bVar = (C0017b) it.next();
            if (bVar.a == C0017b.a.AVAILABLE || bVar.a == C0017b.a.NOT_AVAILABLE) {
                bVar.a(C0017b.a.NEEDS_RELOAD);
            }
        }
        Iterator it2 = this.c.iterator();
        while (it2.hasNext()) {
            C0017b bVar2 = (C0017b) it2.next();
            if (bVar2.a == C0017b.a.NEEDS_RELOAD) {
                try {
                    IronLog ironLog = IronLog.INTERNAL;
    ...
    public final void d(ag agVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, agVar.d + ":onRewardedVideoAdEnded()", 1);
        a((int) IronSourceConstants.RV_INSTANCE_ENDED, (C0017b) agVar, new Object[][]{new Object[]{"placement", p()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(agVar.w)}});
    ...
    public synchronized void e() {
        ...
        L_0x0031:
            ...
            com.ironsource.mediationsdk.b r3 = (com.ironsource.mediationsdk.C0017b) r3     // Catch:{ all -> 0x0092 }
            com.ironsource.mediationsdk.b$a r4 = r3.a     // Catch:{ all -> 0x0092 }
            com.ironsource.mediationsdk.b$a r5 = com.ironsource.mediationsdk.C0017b.a.NOT_AVAILABLE     // Catch:{ all -> 0x0092 }
            ...
            r8.a((int) r4, (com.ironsource.mediationsdk.C0017b) r3, (java.lang.Object[][]) r1)     // Catch:{ all -> 0x006b }
            r4 = r3
            com.ironsource.mediationsdk.ag r4 = (com.ironsource.mediationsdk.ag) r4     // Catch:{ all -> 0x006b }
        ...
        L_0x0092:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.af.e():void");
    }

    public final void e(ag agVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, agVar.d + ":onRewardedVideoAdRewarded()", 1);
        if (this.t == null) {
            this.t = L.a().i.c.a.a();
        }
        JSONObject providerAdditionalData = IronSourceUtils.getProviderAdditionalData((C0017b) agVar);
        try {
        ...
        if (!TextUtils.isEmpty(this.g)) {
            cVar.a(IronSourceConstants.EVENTS_TRANS_ID, (Object) IronSourceUtils.getTransId(cVar.b(), agVar.j()));
            if (!TextUtils.isEmpty(L.a().m)) {
                cVar.a(IronSourceConstants.EVENTS_DYNAMIC_USER_ID, (Object) L.a().m);
            }
    ...
    public final void f(ag agVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, agVar.d + ":onRewardedVideoAdClicked()", 1);
        if (this.t == null) {
            this.t = L.a().i.c.a.a();
        }
        if (this.t == null) {
        ...
        a(1006, (C0017b) agVar, new Object[][]{new Object[]{"placement", p()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(agVar.w)}});
    ...
    public final void g() {
        ...
        while (it.hasNext()) {
            ...
            if (bVar.a == C0017b.a.CAPPED_PER_DAY) {
                ...
                bVar.a(C0017b.a.NOT_AVAILABLE);
                if (((ag) bVar).o() && bVar.c()) {
                    bVar.a(C0017b.a.AVAILABLE);
                    z = true;
                }
            }
        }
    ...
    public final void g(ag agVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, agVar.d + ":onRewardedVideoAdVisible()", 1);
        if (this.t != null) {
            a((int) IronSourceConstants.RV_INSTANCE_VISIBLE, (C0017b) agVar, new Object[][]{new Object[]{"placement", p()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(agVar.w)}});
            return;
        }
        this.h.log(IronSourceLogger.IronSourceTag.INTERNAL, "mCurrentPlacement is null", 3);
    }
