...
public final class i implements InterstitialListener, RewardedVideoListener, SegmentListener, f {
    ...
    public final void a(final IronSourceError ironSourceError, Map<String, Object> map) {
        ...
        h.d().b(new c(IronSourceConstants.RV_CALLBACK_SHOW_FAILED, mediationAdditionalData));
        if (a((Object) this.a)) {
    ...
    public final void a(final boolean z, IronSourceError ironSourceError) {
        ...
        h.d().b(new c(302, mediationAdditionalData));
        if (a((Object) this.c)) {
            a((Runnable) new Runnable() {
                public final void run() {
    ...
    public final void a(final boolean z, Map<String, Object> map) {
        ...
        h.d().b(new c(z ? IronSourceConstants.RV_CALLBACK_AVAILABILITY_TRUE : IronSourceConstants.RV_CALLBACK_AVAILABILITY_FALSE, mediationAdditionalData));
        if (a((Object) this.a)) {
            a((Runnable) new Runnable() {
                public final void run() {
    ...
    public final void onInterstitialAdShowFailed(final IronSourceError ironSourceError) {
        ...
        d.d().b(new c(IronSourceConstants.IS_CALLBACK_AD_SHOW_ERROR, mediationAdditionalData));
        if (a((Object) this.b)) {
            a((Runnable) new Runnable() {
                public final void run() {
