...
public final class C0021f {
    private static C0021f b = new C0021f();
    ...
    static class b implements Runnable {
        ...
        public final void run() {
            ...
            if (!z) {
                ...
                h.d().b(new com.ironsource.mediationsdk.a.c(IronSourceConstants.TROUBLESHOOTING_FAILED_TO_SEND_AUCTION_URL, jSONObject));
            }
        }
    }
    ...
    private static int b() {
        /*
            int r0 = com.ironsource.mediationsdk.C0021f.c.b
        ...
        L_0x0032:
            if (r0 == 0) goto L_0x0013
        L_0x0034:
            int r0 = com.ironsource.mediationsdk.C0021f.c.a
        L_0x0036:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.C0021f.b():int");
    }
    ...
    public final JSONObject a(Context context, Map<String, Object> map, List<String> list, C0025j jVar, int i, String str, com.ironsource.mediationsdk.utils.c cVar, ISBannerSize iSBannerSize, JSONObject jSONObject) {
        String str2;
        String str3;
        boolean z;
        C0025j jVar2 = jVar;
        ...
        if (list != null) {
            for (String next2 : list) {
                ...
                jSONObject5.put("performance", jVar2 != null ? jVar2.a(next2) : str2);
        ...
        jSONObject7.put("applicationUserId", L.a().k);
        Boolean bool = L.a().y;
        if (bool != null) {
        ...
        jSONObject8.put("applicationKey", L.a().j);
    ...
    /* access modifiers changed from: package-private */
    public final JSONObject a(String str, boolean z, Map<String, Object> map, List<String> list, C0025j jVar, int i, ISBannerSize iSBannerSize, JSONObject jSONObject) {
        String str2;
        C0025j jVar2 = jVar;
        JSONObject jSONObject2 = jSONObject;
        JSONObject jSONObject3 = new JSONObject();
        ...
        if (list != null) {
            for (String next2 : list) {
                ...
                jSONObject6.put("prfm", jVar2 != null ? jVar2.a(next2) : str2);
    ...
    public final JSONObject a(JSONObject jSONObject, JSONObject jSONObject2, List<String> list) {
        JSONObject d = d(al.a().b(), list);
        a(d, b(jSONObject, list));
        a(d, c(jSONObject2, list));
        return d;
    }
    ...
    public final void a(JSONObject jSONObject, boolean z) {
        if (jSONObject != null && jSONObject.length() > 0 && !TextUtils.isEmpty(jSONObject.optString("tcs")) && this.a.compareAndSet(false, true)) {
            h.d().b(new com.ironsource.mediationsdk.a.c(IronSourceConstants.TROUBLESHOOTING_MEDIATION_TCS_CALCULATED, IronSourceUtils.getMediationAdditionalData(z, true, -1)));
        }
    }
}
