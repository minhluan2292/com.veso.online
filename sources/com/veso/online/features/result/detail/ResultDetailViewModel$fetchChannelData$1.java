...
@DebugMetadata(c = "com.veso.online.features.result.detail.ResultDetailViewModel$fetchChannelData$1", f = "ResultDetailViewModel.kt", i = {}, l = {61, 67}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: ResultDetailViewModel.kt */
final class ResultDetailViewModel$fetchChannelData$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    ResultDetailViewModel$fetchChannelData$1(ResultDetailViewModel resultDetailViewModel, String str, int i, String str2, Continuation<? super ResultDetailViewModel$fetchChannelData$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ResultDetailViewModel$fetchChannelData$1(this.this$0, this.$channelId, this.$pageIndex, this.$date, continuation);
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ResultDetailViewModel$fetchChannelData$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = XosoRepository.INSTANCE.retrieveChannelResult(this.$channelId, this.$pageIndex, this.$date, this);
