...
public class a {
    ...
    private final HashMap<View, C0001a> b = new HashMap<>();
    ...
    public static class C0001a {
        ...
        public C0001a(c cVar, String str) {
            this.a = cVar;
            a(str);
        }
    ...
    private void a(c cVar, com.iab.omid.library.ironsrc.adsession.a aVar) {
        ...
        if (view != null) {
            C0001a aVar2 = this.b.get(view);
            if (aVar2 != null) {
                aVar2.a(aVar.getAdSessionId());
            } else {
                this.b.put(view, new C0001a(cVar, aVar.getAdSessionId()));
            }
        }
    }
    ...
    public C0001a b(View view) {
        C0001a aVar = this.b.get(view);
        if (aVar != null) {
            this.b.remove(view);
        }
        return aVar;
