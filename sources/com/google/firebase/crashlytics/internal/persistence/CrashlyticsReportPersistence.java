...
public class CrashlyticsReportPersistence {
    ...
    private static final FilenameFilter EVENT_FILE_FILTER = CrashlyticsReportPersistence$$ExternalSyntheticLambda1.INSTANCE;
    private static final String EVENT_FILE_NAME_PREFIX = "event";
    private static final int EVENT_NAME_LENGTH = 15;
    private static final Comparator<? super File> LATEST_SESSION_ID_FIRST_COMPARATOR = CrashlyticsReportPersistence$$ExternalSyntheticLambda3.INSTANCE;
    ...
    private int trimEvents(String str, int i) {
        List<File> sessionFiles = this.fileStore.getSessionFiles(str, CrashlyticsReportPersistence$$ExternalSyntheticLambda0.INSTANCE);
        Collections.sort(sessionFiles, CrashlyticsReportPersistence$$ExternalSyntheticLambda2.INSTANCE);
