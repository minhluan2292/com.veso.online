...
class GmsRpc {
    ...
    public Task<?> deleteToken() {
        ...
        bundle.putString(EXTRA_DELETE, XosoConfig.REGION_ID_SOUTH);
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(WindowInfoTrackerImpl$windowLayoutInfo$1$$ExternalSyntheticLambda1.INSTANCE, new GmsRpc$$ExternalSyntheticLambda0(this));
    }

    /* renamed from: lambda$extractResponseWhenComplete$0$com-google-firebase-messaging-GmsRpc  reason: not valid java name */
    public /* synthetic */ String m514lambda$extractResponseWhenComplete$0$comgooglefirebasemessagingGmsRpc(Task task) throws Exception {
