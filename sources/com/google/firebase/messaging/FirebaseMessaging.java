...
public class FirebaseMessaging {
    ...
    FirebaseMessaging(FirebaseApp firebaseApp2, FirebaseInstanceIdInternal firebaseInstanceIdInternal, FirebaseInstallationsApi firebaseInstallationsApi, TransportFactory transportFactory2, Subscriber subscriber, Metadata metadata2, GmsRpc gmsRpc2, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new FirebaseMessaging$$ExternalSyntheticLambda5(this));
        }
        ...
        executor2.execute(new FirebaseMessaging$$ExternalSyntheticLambda8(this));
    }

    /* renamed from: lambda$new$1$com-google-firebase-messaging-FirebaseMessaging  reason: not valid java name */
    public /* synthetic */ void m510lambda$new$1$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public /* synthetic */ void m511lambda$new$2$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public /* synthetic */ void m512lambda$new$3$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new FirebaseMessaging$$ExternalSyntheticLambda1(this, taskCompletionSource));
        return taskCompletionSource.getTask();
    }

    /* renamed from: lambda$getToken$4$com-google-firebase-messaging-FirebaseMessaging  reason: not valid java name */
    public /* synthetic */ void m508lambda$getToken$4$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m506lambda$deleteToken$5$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m507lambda$deleteToken$6$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> unsubscribeFromTopic(String str) {
        return this.topicsSubscriberTask.onSuccessTask(new FirebaseMessaging$$ExternalSyntheticLambda4(str));
    }
    ...
    public String blockingGetToken() throws IOException {
        ...
        if (firebaseInstanceIdInternal != null) {
            ...
            try {
                return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new FirebaseMessaging$$ExternalSyntheticLambda6(this, defaultSenderId, tokenWithoutTriggeringSync)));
    ...
    public /* synthetic */ Task m504lambda$blockingGetToken$10$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token) {
        return this.gmsRpc.getToken().onSuccessTask(this.fileExecutor, new FirebaseMessaging$$ExternalSyntheticLambda2(this, str, token));
    }

    /* renamed from: lambda$blockingGetToken$9$com-google-firebase-messaging-FirebaseMessaging  reason: not valid java name */
    public /* synthetic */ Task m505lambda$blockingGetToken$9$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token, String str2) throws Exception {
        getStore(this.context).saveToken(getSubtype(), str, str2, this.metadata.getAppVersionCode());
        if (token == null || !str2.equals(token.token)) {
            m509lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(str2);
        }
    ...
    public void m509lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(String str) {
        if (FirebaseApp.DEFAULT_APP_NAME.equals(this.firebaseApp.getName())) {
    ...
    private class AutoInit {
        ...
        public /* synthetic */ void m513lambda$initialize$0$comgooglefirebasemessagingFirebaseMessaging$AutoInit(Event event) {
            if (isEnabled()) {
