...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    private static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        private static final FieldDescriptor INSTANCEID_DESCRIPTOR = FieldDescriptor.builder(ImpressionData.IMPRESSION_DATA_KEY_INSTANCE_ID).withProperty(AtProtobuf.builder().tag(3).build()).build();
