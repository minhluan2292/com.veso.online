...
public abstract class EnhancedIntentService extends Service {
    ...
    public /* synthetic */ void m502lambda$processIntent$0$comgooglefirebasemessagingEnhancedIntentService(Intent intent, TaskCompletionSource taskCompletionSource) {
        try {
            handleIntent(intent);
        } finally {
    ...
    public final int onStartCommand(Intent intent, int i, int i2) {
        ...
        processIntent.addOnCompleteListener((Executor) WindowInfoTrackerImpl$windowLayoutInfo$1$$ExternalSyntheticLambda1.INSTANCE, (OnCompleteListener<Void>) new EnhancedIntentService$$ExternalSyntheticLambda0(this, intent));
        return 3;
    }

    /* renamed from: lambda$onStartCommand$1$com-google-firebase-messaging-EnhancedIntentService  reason: not valid java name */
    public /* synthetic */ void m501lambda$onStartCommand$1$comgooglefirebasemessagingEnhancedIntentService(Intent intent, Task task) {
        finishTask(intent);
    }
