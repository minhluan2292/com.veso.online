...
public class NotificationParams {
    ...
    public boolean getBoolean(String str) {
        ...
        return XosoConfig.REGION_ID_SOUTH.equals(string) || Boolean.parseBoolean(string);
    }
    ...
    public static boolean isNotification(Bundle bundle) {
        return XosoConfig.REGION_ID_SOUTH.equals(bundle.getString(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)) || XosoConfig.REGION_ID_SOUTH.equals(bundle.getString(keyWithOldPrefix(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)));
    }
