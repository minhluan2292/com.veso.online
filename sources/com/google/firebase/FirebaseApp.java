...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.dataCollectionConfigStorage = new Lazy<>(new FirebaseApp$$ExternalSyntheticLambda1(this, context));
    ...
    public /* synthetic */ DataCollectionConfigStorage m482lambda$new$0$comgooglefirebaseFirebaseApp(Context context) {
    ...
    public /* synthetic */ void m483lambda$new$1$comgooglefirebaseFirebaseApp(boolean z) {
        if (!z) {
