...
public final class zzc {
    ...
    private static final List zzc = Arrays.asList(new String[]{DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "app", "am"});
    ...
    public static Bundle zza(AnalyticsConnector.ConditionalUserProperty conditionalUserProperty) {
        ...
        if (conditionalUserProperty.value != null) {
            zzhg.zzb(bundle, conditionalUserProperty.value);
        }
    ...
    public static AnalyticsConnector.ConditionalUserProperty zzb(Bundle bundle) {
        ...
        conditionalUserProperty.origin = (String) Preconditions.checkNotNull((String) zzhg.zza(bundle, "origin", String.class, (Object) null));
        conditionalUserProperty.name = (String) Preconditions.checkNotNull((String) zzhg.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.NAME, String.class, (Object) null));
        conditionalUserProperty.value = zzhg.zza(bundle, "value", Object.class, (Object) null);
        conditionalUserProperty.triggerEventName = (String) zzhg.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGER_EVENT_NAME, String.class, (Object) null);
        ...
        conditionalUserProperty.timedOutEventName = (String) zzhg.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_NAME, String.class, (Object) null);
        conditionalUserProperty.timedOutEventParams = (Bundle) zzhg.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS, Bundle.class, (Object) null);
        conditionalUserProperty.triggeredEventName = (String) zzhg.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_NAME, String.class, (Object) null);
        conditionalUserProperty.triggeredEventParams = (Bundle) zzhg.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_PARAMS, Bundle.class, (Object) null);
        ...
        conditionalUserProperty.expiredEventName = (String) zzhg.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME, String.class, (Object) null);
        conditionalUserProperty.expiredEventParams = (Bundle) zzhg.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_PARAMS, Bundle.class, (Object) null);
        conditionalUserProperty.active = ((Boolean) zzhg.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.ACTIVE, Boolean.class, false)).booleanValue();
    ...
    public static boolean zzi(AnalyticsConnector.ConditionalUserProperty conditionalUserProperty) {
        ...
        if ((conditionalUserProperty.value != null && zziv.zza(conditionalUserProperty.value) == null) || !zzl(str) || !zzm(str, conditionalUserProperty.name)) {
            return false;
        }
