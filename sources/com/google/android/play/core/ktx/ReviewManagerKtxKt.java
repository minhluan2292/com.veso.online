...
public final class ReviewManagerKtxKt {
    ...
    public static final <T> Object runTask(Task<T> task, Function0<Unit> function0, Continuation<? super T> continuation) {
        ...
        if (!task.isComplete()) {
            ...
            cancellableContinuation.resumeWith(Result.m599constructorimpl(task.getResult()));
        } else {
            Exception exception = task.getException();
            Intrinsics.checkNotNull(exception);
            cancellableContinuation.resumeWith(Result.m599constructorimpl(ResultKt.createFailure(exception)));
        }
    ...
    public static final <E> boolean tryOffer(SendChannel<? super E> sendChannel, E e) {
        ...
        return ChannelResult.m415isSuccessimpl(sendChannel.m427trySendJP2dKIU(e));
    }
}
