...
public class SQLiteEventStore implements EventStore, SynchronizationGuard, ClientHealthMetricsStore {
    ...
    public SQLiteDatabase getDb() {
        ...
        return (SQLiteDatabase) retryIfDbLocked(new SQLiteEventStore$$ExternalSyntheticLambda19(schemaManager2), SQLiteEventStore$$ExternalSyntheticLambda17.INSTANCE);
    }
    ...
    public PersistedEvent persist(TransportContext transportContext, EventInternal eventInternal) {
        ...
        long longValue = ((Long) inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda25(this, eventInternal, transportContext))).longValue();
        if (longValue < 1) {
            return null;
        }
    ...
    public /* synthetic */ Long m115lambda$persist$1$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(EventInternal eventInternal, TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        if (isStorageAtLimit()) {
    ...
    private Long getTransportContextId(SQLiteDatabase sQLiteDatabase, TransportContext transportContext) {
        ...
        return (Long) tryWithCursor(sQLiteDatabase.query("transport_contexts", new String[]{"_id"}, sb.toString(), (String[]) arrayList.toArray(new String[0]), (String) null, (String) null, (String) null), SQLiteEventStore$$ExternalSyntheticLambda8.INSTANCE);
    }
    ...
    public void recordFailure(Iterable<PersistedEvent> iterable) {
        if (iterable.iterator().hasNext()) {
            inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda1(this, "UPDATE events SET num_attempts = num_attempts + 1 WHERE _id in " + toIdList(iterable), "SELECT COUNT(*), transport_name FROM events WHERE num_attempts >= 16 GROUP BY transport_name"));
        }
    }
    ...
    public /* synthetic */ Object m117lambda$recordFailure$4$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(String str, String str2, SQLiteDatabase sQLiteDatabase) {
        sQLiteDatabase.compileStatement(str).execute();
        tryWithCursor(sQLiteDatabase.rawQuery(str2, (String[]) null), new SQLiteEventStore$$ExternalSyntheticLambda22(this));
    ...
    public /* synthetic */ Object m116lambda$recordFailure$3$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Cursor cursor) {
    ...
    public /* synthetic */ Boolean m110lambda$hasPendingEventsFor$6$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        Long transportContextId = getTransportContextId(sQLiteDatabase, transportContext);
        if (transportContextId == null) {
            return false;
        }
        return (Boolean) tryWithCursor(getDb().rawQuery("SELECT 1 FROM events WHERE context_id = ? LIMIT 1", new String[]{transportContextId.toString()}), SQLiteEventStore$$ExternalSyntheticLambda13.INSTANCE);
    }

    public void recordNextCallTime(TransportContext transportContext, long j) {
        inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda20(j, transportContext));
    }
    ...
    public Iterable<PersistedEvent> loadBatch(TransportContext transportContext) {
        return (Iterable) inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda27(this, transportContext));
    }
    ...
    public /* synthetic */ List m111lambda$loadBatch$8$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
    ...
    static /* synthetic */ List lambda$loadActiveContexts$10(SQLiteDatabase sQLiteDatabase) {
        return (List) tryWithCursor(sQLiteDatabase.rawQuery("SELECT distinct t._id, t.backend_name, t.priority, t.extras FROM transport_contexts AS t, events AS e WHERE e.context_id = t._id", new String[0]), SQLiteEventStore$$ExternalSyntheticLambda9.INSTANCE);
    }
    ...
    public int cleanUp() {
        return ((Integer) inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda24(this, this.wallClock.getTime() - this.config.getEventCleanUpAge()))).intValue();
    }
    ...
    public /* synthetic */ Integer m109lambda$cleanUp$12$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(long j, SQLiteDatabase sQLiteDatabase) {
        String[] strArr = {String.valueOf(j)};
        tryWithCursor(sQLiteDatabase.rawQuery("SELECT COUNT(*), transport_name FROM events WHERE timestamp_ms < ? GROUP BY transport_name", strArr), new SQLiteEventStore$$ExternalSyntheticLambda21(this));
    ...
    public /* synthetic */ Object m108lambda$cleanUp$11$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Cursor cursor) {
        while (cursor.moveToNext()) {
            int i = cursor.getInt(0);
    ...
    private List<PersistedEvent> loadEvents(SQLiteDatabase sQLiteDatabase, TransportContext transportContext) {
        ...
        tryWithCursor(sQLiteDatabase2.query("events", new String[]{"_id", "transport_name", "timestamp_ms", "uptime_ms", "payload_encoding", "payload", "code", "inline"}, "context_id = ?", new String[]{transportContextId.toString()}, (String) null, (String) null, (String) null, String.valueOf(this.config.getLoadBatchSize())), new SQLiteEventStore$$ExternalSyntheticLambda3(this, arrayList, transportContext));
        return arrayList;
    }
    ...
    public /* synthetic */ Object m114lambda$loadEvents$14$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(List list, TransportContext transportContext, Cursor cursor) {
        while (cursor.moveToNext()) {
            boolean z = false;
    ...
    private byte[] readPayload(long j) {
        return (byte[]) tryWithCursor(getDb().query("event_payloads", new String[]{"bytes"}, "event_id = ?", new String[]{String.valueOf(j)}, (String) null, (String) null, "sequence_num"), SQLiteEventStore$$ExternalSyntheticLambda10.INSTANCE);
    }
    ...
    private Map<Long, Set<Metadata>> loadMetadata(SQLiteDatabase sQLiteDatabase, List<PersistedEvent> list) {
        ...
        sb.append(')');
        tryWithCursor(sQLiteDatabase.query("event_metadata", new String[]{"event_id", AppMeasurementSdk.ConditionalUserProperty.NAME, "value"}, sb.toString(), (String[]) null, (String) null, (String) null, (String) null), new SQLiteEventStore$$ExternalSyntheticLambda6(hashMap));
        return hashMap;
    }
    ...
    public void recordLogEventDropped(long j, LogEventDropped.Reason reason, String str) {
        inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda5(str, reason, j));
    }
    ...
    static /* synthetic */ Object lambda$recordLogEventDropped$18(String str, LogEventDropped.Reason reason, long j, SQLiteDatabase sQLiteDatabase) {
        if (!((Boolean) tryWithCursor(sQLiteDatabase.rawQuery("SELECT 1 FROM log_event_dropped WHERE log_source = ? AND reason = ?", new String[]{str, Integer.toString(reason.getNumber())}), SQLiteEventStore$$ExternalSyntheticLambda12.INSTANCE)).booleanValue()) {
            ContentValues contentValues = new ContentValues();
    ...
    public ClientMetrics loadClientMetrics() {
        return (ClientMetrics) inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda2(this, "SELECT log_source, reason, events_dropped_count FROM log_event_dropped", new HashMap(), ClientMetrics.newBuilder()));
    }
    ...
    public /* synthetic */ ClientMetrics m113lambda$loadClientMetrics$20$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(String str, Map map, ClientMetrics.Builder builder, SQLiteDatabase sQLiteDatabase) {
        return (ClientMetrics) tryWithCursor(sQLiteDatabase.rawQuery(str, new String[0]), new SQLiteEventStore$$ExternalSyntheticLambda4(this, map, builder));
    }
    ...
    public /* synthetic */ ClientMetrics m112lambda$loadClientMetrics$19$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Map map, ClientMetrics.Builder builder, Cursor cursor) {
        while (cursor.moveToNext()) {
    ...
    private TimeWindow getTimeWindow() {
        return (TimeWindow) inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda11(this.wallClock.getTime()));
    }

    static /* synthetic */ TimeWindow lambda$getTimeWindow$22(long j, SQLiteDatabase sQLiteDatabase) {
        return (TimeWindow) tryWithCursor(sQLiteDatabase.rawQuery("SELECT last_metrics_upload_ms FROM global_log_event_state LIMIT 1", new String[0]), new SQLiteEventStore$$ExternalSyntheticLambda0(j));
    }
    ...
    public void resetClientMetrics() {
        inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda23(this));
    }
    ...
    public /* synthetic */ Object m118lambda$resetClientMetrics$23$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(SQLiteDatabase sQLiteDatabase) {
    ...
    private void ensureBeginTransaction(SQLiteDatabase sQLiteDatabase) {
        retryIfDbLocked(new SQLiteEventStore$$ExternalSyntheticLambda18(sQLiteDatabase), SQLiteEventStore$$ExternalSyntheticLambda16.INSTANCE);
    }
