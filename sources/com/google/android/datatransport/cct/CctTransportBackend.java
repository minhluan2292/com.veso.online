    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        ...
        try {
            ...
            try {
                ...
                Logging.d(LOG_TAG, "Content-Type: %s", (Object) httpURLConnection.getHeaderField(CONTENT_TYPE_HEADER_KEY));
