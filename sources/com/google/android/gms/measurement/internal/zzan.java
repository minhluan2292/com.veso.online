...
public final class zzan {
    ...
    static void zza(com.google.android.gms.measurement.internal.zzfa r14, android.database.sqlite.SQLiteDatabase r15, java.lang.String r16, java.lang.String r17, java.lang.String r18, java.lang.String[] r19) throws android.database.sqlite.SQLiteException {
        /*
            r9 = r15
            r10 = r16
            r11 = r19
        ...
        L_0x0031:
            ...
            r1 = r13
        L_0x0033:
            com.google.android.gms.measurement.internal.zzey r2 = r14.zzk()     // Catch:{ all -> 0x00e2 }
        ...
        L_0x00bc:
            ...
            com.google.android.gms.measurement.internal.zzey r1 = r14.zzk()     // Catch:{ SQLiteException -> 0x00d7 }
        ...
        L_0x00d7:
            r0 = move-exception
            com.google.android.gms.measurement.internal.zzey r1 = r14.zzd()
        ...
        L_0x00ea:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzan.zza(com.google.android.gms.measurement.internal.zzfa, android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String, java.lang.String, java.lang.String[]):void");
    }

    static void zzb(zzfa zzfa, SQLiteDatabase sQLiteDatabase) {
        if (zzfa != null) {
            File file = new File(sQLiteDatabase.getPath());
            if (!file.setReadable(false, false)) {
                zzfa.zzk().zza("Failed to turn off database read permission");
            }
            if (!file.setWritable(false, false)) {
                zzfa.zzk().zza("Failed to turn off database write permission");
            }
            if (!file.setReadable(true, true)) {
                zzfa.zzk().zza("Failed to turn on database read permission for owner");
            }
            if (!file.setWritable(true, true)) {
                zzfa.zzk().zza("Failed to turn on database write permission for owner");
                return;
            }
            return;
        }
