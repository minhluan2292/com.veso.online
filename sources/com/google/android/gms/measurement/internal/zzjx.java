...
final class zzjx implements Runnable {
    ...
    zzjx(zzke zzke, AtomicReference atomicReference, String str, String str2, String str3, zzq zzq, boolean z) {
        this.zzf = zzke;
    ...
    public final void run() {
        ...
        synchronized (this.zza) {
            try {
                ...
                zzeq zzh = zzke.zzb;
                if (zzh == null) {
                    zzke.zzs.zzay().zzd().zzd("(legacy) Failed to get user properties; not connected to service", (Object) null, this.zzb, this.zzc);
