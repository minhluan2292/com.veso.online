...
final class zzis implements Runnable {
    ...
    public zzis(zzit zzit, String str, URL url, byte[] bArr, Map map, zzgi zzgi, byte[] bArr2) {
        this.zza = zzit;
    ...
    private final void zzb(int i, Exception exc, byte[] bArr, Map map) {
        this.zza.zzs.zzaz().zzp(new zzir(this, i, exc, bArr, map));
    }
    ...
    public final void run() {
        /*
            r10 = this;
            com.google.android.gms.measurement.internal.zzit r0 = r10.zza
            r0.zzax()
            r0 = 0
            r1 = 0
            com.google.android.gms.measurement.internal.zzit r2 = r10.zza     // Catch:{ IOException -> 0x0097, all -> 0x0088 }
            ...
            com.google.android.gms.measurement.internal.zzgk r4 = r2.zzs     // Catch:{ IOException -> 0x0097, all -> 0x0088 }
            r4.zzf()     // Catch:{ IOException -> 0x0097, all -> 0x0088 }
            r4 = 60000(0xea60, float:8.4078E-41)
            r3.setConnectTimeout(r4)     // Catch:{ IOException -> 0x0097, all -> 0x0088 }
            com.google.android.gms.measurement.internal.zzgk r2 = r2.zzs     // Catch:{ IOException -> 0x0097, all -> 0x0088 }
    ...
    public final /* synthetic */ void zza(int i, Exception exc, byte[] bArr, Map map) {
        zzgi zzgi = this.zzd;
        zzgi.zza.zzC(this.zzc, i, exc, bArr, map);
    }
}
