...
final class zzfi extends BroadcastReceiver {
    static final String zza = "com.google.android.gms.measurement.internal.zzfi";
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if ("android.net.conn.CONNECTIVITY_CHANGE".equals(action)) {
            ...
            if (this.zzd != zza2) {
                this.zzd = zza2;
                this.zzb.zzaz().zzp(new zzfh(this, zza2));
                return;
            }
            return;
        }
