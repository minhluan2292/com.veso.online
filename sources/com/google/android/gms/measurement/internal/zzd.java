...
public final class zzd extends zze {
    ...
    static /* synthetic */ void zzb(zzd zzd, String str, long j) {
        ...
        Integer num = (Integer) zzd.zzb.get(str);
        if (num != null) {
            zziw zzj = zzd.zzs.zzs().zzj(false);
    ...
    private final void zzh(long j, zziw zziw) {
        if (zziw == null) {
            ...
            zzlt.zzK(zziw, bundle, true);
            this.zzs.zzq().zzH("am", "_xa", bundle);
        }
    }

    private final void zzi(String str, long j, zziw zziw) {
        if (zziw == null) {
