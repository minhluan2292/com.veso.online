...
public final class zzag extends zzhd {
    ...
    public static final long zzA() {
        return ((Long) zzen.zzC.zza((Object) null)).longValue();
    }
    ...
    public final double zza(String str, zzem zzem) {
        if (str == null) {
            return ((Double) zzem.zza((Object) null)).doubleValue();
        }
        String zza2 = this.zzb.zza(str, zzem.zzb());
        if (TextUtils.isEmpty(zza2)) {
            return ((Double) zzem.zza((Object) null)).doubleValue();
        }
        try {
            return ((Double) zzem.zza(Double.valueOf(Double.parseDouble(zza2)))).doubleValue();
    ...
    public final int zzb(String str) {
        return zzf(str, zzen.zzG, ServiceStarter.ERROR_UNKNOWN, 2000);
    }
    ...
    public final int zze(String str, zzem zzem) {
        if (str == null) {
            return ((Integer) zzem.zza((Object) null)).intValue();
        }
        String zza2 = this.zzb.zza(str, zzem.zzb());
        if (TextUtils.isEmpty(zza2)) {
            return ((Integer) zzem.zza((Object) null)).intValue();
        ...
        try {
            return ((Integer) zzem.zza(Integer.valueOf(Integer.parseInt(zza2)))).intValue();
        } catch (NumberFormatException unused) {
            return ((Integer) zzem.zza((Object) null)).intValue();
        }
    }

    public final int zzf(String str, zzem zzem, int i, int i2) {
        return Math.max(Math.min(zze(str, zzem), i2), i);
    }
    ...
    public final long zzi(String str, zzem zzem) {
        if (str == null) {
            return ((Long) zzem.zza((Object) null)).longValue();
        }
        String zza2 = this.zzb.zza(str, zzem.zzb());
        if (TextUtils.isEmpty(zza2)) {
            return ((Long) zzem.zza((Object) null)).longValue();
        ...
        try {
            return ((Long) zzem.zza(Long.valueOf(Long.parseLong(zza2)))).longValue();
        } catch (NumberFormatException unused) {
            return ((Long) zzem.zza((Object) null)).longValue();
        }
    }
    ...
    public final String zzo(String str, zzem zzem) {
        if (str == null) {
            return (String) zzem.zza((Object) null);
        }
        return (String) zzem.zza(this.zzb.zza(str, zzem.zzb()));
    }
    ...
    public final java.util.List zzp(java.lang.String r4) {
        /*
            ...
            com.google.android.gms.measurement.internal.zzey r4 = r4.zzd()
        ...
        L_0x002c:
            ...
            com.google.android.gms.measurement.internal.zzgk r0 = r3.zzs     // Catch:{ NotFoundException -> 0x0048 }
    ...
    public final boolean zzs(String str, zzem zzem) {
        if (str == null) {
            return ((Boolean) zzem.zza((Object) null)).booleanValue();
        }
        String zza2 = this.zzb.zza(str, zzem.zzb());
        if (TextUtils.isEmpty(zza2)) {
            return ((Boolean) zzem.zza((Object) null)).booleanValue();
        }
        return ((Boolean) zzem.zza(Boolean.valueOf(XosoConfig.REGION_ID_SOUTH.equals(zza2)))).booleanValue();
    }

    public final boolean zzt(String str) {
        return XosoConfig.REGION_ID_SOUTH.equals(this.zzb.zza(str, "gaia_collection_enabled"));
    }
    ...
    public final boolean zzw(String str) {
        return XosoConfig.REGION_ID_SOUTH.equals(this.zzb.zza(str, "measurement.event_sampling_enabled"));
    }
