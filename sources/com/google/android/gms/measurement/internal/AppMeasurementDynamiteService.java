...
public class AppMeasurementDynamiteService extends zzcb {
    ...
    public void initialize(IObjectWrapper iObjectWrapper, zzcl zzcl, long j) throws RemoteException {
        zzgk zzgk = this.zza;
        if (zzgk == null) {
            this.zza = zzgk.zzp((Context) Preconditions.checkNotNull((Context) ObjectWrapper.unwrap(iObjectWrapper)), zzcl, Long.valueOf(j));
        } else {
            zzgk.zzay().zzk().zza("Attempting to initialize multiple times");
        }
    }
    ...
    public void registerOnMeasurementEventListener(zzci zzci) throws RemoteException {
        ...
        synchronized (this.zzb) {
            zzhl = (zzhl) this.zzb.get(Integer.valueOf(zzci.zzd()));
            if (zzhl == null) {
                zzhl = new zzp(this, zzci);
                this.zzb.put(Integer.valueOf(zzci.zzd()), zzhl);
            }
        }
        this.zza.zzq().zzK(zzhl);
    }
    ...
    public void setDefaultEventParameters(Bundle bundle) {
        ...
        zzq.zzs.zzaz().zzp(new zzhp(zzq, bundle2));
    }
    ...
    public void setUserId(String str, long j) throws RemoteException {
        ...
        if (str == null || !TextUtils.isEmpty(str)) {
            zzq.zzs.zzaz().zzp(new zzhq(zzq, str));
            zzq.zzZ((String) null, "_id", str, true, j);
            return;
        }
    ...
    public void unregisterOnMeasurementEventListener(zzci zzci) throws RemoteException {
        ...
        zzb();
        synchronized (this.zzb) {
            zzhl = (zzhl) this.zzb.remove(Integer.valueOf(zzci.zzd()));
        }
        if (zzhl == null) {
            zzhl = new zzp(this, zzci);
        }
        this.zza.zzq().zzab(zzhl);
    }
}
