...
abstract class zzy {
    ...
    private static Boolean zzd(String str, int i, boolean z, String str2, List list, String str3, zzfa zzfa) {
        if (i == 7) {
        ...
        switch (i - 1) {
            case 1:
                ...
                try {
                    ...
                    if (zzfa != null) {
                        zzfa.zzk().zzb("Invalid regular expression in REGEXP audience filter. expression", str3);
                    }
                    return null;
                }
            case 2:
    ...
    static Boolean zze(BigDecimal bigDecimal, zzeq zzeq, double d) {
        ...
        if (zzeq.zzg()) {
            ...
            if (zzeq.zzm() != 1) {
                ...
                int zzm = zzeq.zzm();
                if (zzeq.zzm() == 5) {
                    if (zzln.zzx(zzeq.zze()) && zzln.zzx(zzeq.zzd())) {
                        try {
    ...
    static Boolean zzf(String str, zzex zzex, zzfa zzfa) {
        String str2;
        List list;
        ...
        return zzd(str, zzj, zzf2, str3, list, zzj == 2 ? str3 : null, zzfa);
    }
