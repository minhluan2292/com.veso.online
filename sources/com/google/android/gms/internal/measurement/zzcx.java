...
final class zzcx extends zzdt {
    ...
    public final void zza() {
        ...
        try {
            ...
            ((zzcc) Preconditions.checkNotNull(this.zze.zzj)).initialize(ObjectWrapper.wrap(this.zzc), new zzcl(64000, (long) Math.max(localVersion, remoteVersion), remoteVersion < localVersion, str3, str2, str, this.zzd, zzgc.zza(this.zzc)), this.zzh);
        } catch (Exception e) {
