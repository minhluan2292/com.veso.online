...
public final class zzgoe {
    ...
    private static ECParameterSpec zzm(String str, String str2, String str3, String str4, String str5) {
        ...
        return new ECParameterSpec(new EllipticCurve(new ECFieldFp(bigInteger), bigInteger.subtract(new BigInteger(XosoConfig.REGION_ID_MIDDLE)), new BigInteger(str3, 16)), new ECPoint(new BigInteger(str4, 16), new BigInteger(str5, 16)), new BigInteger(str2), 1);
    }
