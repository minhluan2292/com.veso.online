    ...
    public static synchronized zzaox zzb(String str, Context context, Executor executor, boolean z, boolean z2) {
        ...
        synchronized (zzaox.class) {
            if (zzb == null) {
                ...
                zzaox zzaox2 = new zzaox(context, zza3, new zzfom(context2, zzb2), new zzfot(context2, zzb2, new zzaou(zza3), ((Boolean) zzay.zzc().zzb(zzbjc.zzbS)).booleanValue()), new zzfov(context2, zzapy, zza3, zzfms), zzapy, executor, zzfms, zzb2, zzd3);
                zzb = zzaox2;
                zzaox2.zzm();
                zzb.zzo();
            }
