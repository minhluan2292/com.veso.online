...
final class zzpd {
    ...
    private final void zzk() {
                    ...
                    if (i13 > 0) {
                        ...
                        if (this.zzb == i10 && i15 == i10) {
                            ...
                            if (i15 != i10) {
                                ...
                                if (this.zzb == i10) {
                                    i5 = zzg(sArr, i12, i18, i19);
                                } else {
                                    zzi(sArr, i12, i10);
                                    i5 = zzg(this.zzi, 0, i18, i19);
                                }
                            } else {
                                i5 = zzg2;
                            }
                        ...
                        if (d > 1.0d) {
                            ...
                            int i24 = i7;
                            short[] sArr3 = sArr2;
                            zzj(i7, this.zzb, zzl2, this.zzm, sArr3, i12, sArr3, i12 + i23);
                            this.zzm += i24;
                            i12 += i23 + i24;
                        } else {
                            int i25 = i23;
                            ...
                            int i26 = i25 + i6;
                            short[] zzl3 = zzl(this.zzl, this.zzm, i26);
                            this.zzl = zzl3;
                            int i27 = this.zzb;
                            System.arraycopy(sArr4, i12 * i27, zzl3, this.zzm * i27, i27 * i25);
        ...
        if (f4 != f5 && this.zzm != i9) {
            ...
            int i33 = this.zzb;
            System.arraycopy(sArr6, i9 * i33, zzl4, this.zzo * i33, i33 * i32);
            this.zzm = i9;
            this.zzo += i32;
            int i34 = 0;
            while (true) {
