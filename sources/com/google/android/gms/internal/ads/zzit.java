...
final class zzit extends zzm implements zzhl {
    ...
    public zzit(zzhk zzhk, zzcg zzcg) {
        ...
        try {
            ...
            Context applicationContext = zzhk2.zza.getApplicationContext();
            this.zzf = applicationContext;
            ? apply = zzhk2.zzh.apply(zzhk2.zzb);
            this.zzr = apply;
            this.zzW = zzhk2.zzj;
            this.zzQ = zzhk2.zzk;
            this.zzY = false;
            this.zzC = zzhk2.zzo;
            zzip zzip = new zzip(this, (zzio) null);
            this.zzv = zzip;
            zzir zzir = new zzir((zziq) null);
            this.zzw = zzir;
            Handler handler = new Handler(zzhk2.zzi);
            Handler handler2 = handler;
            zzka[] zza2 = ((zzhe) zzhk2.zzc).zza.zza(handler, zzip, zzip, zzip, zzip);
            this.zzh = zza2;
            int length = zza2.length;
            zzvz zzvz = (zzvz) zzhk2.zze.zza();
            this.zzi = zzvz;
            this.zzq = zzhk.zza(((zzhf) zzhk2.zzd).zza);
            zzwl zzg2 = zzwl.zzg(((zzhi) zzhk2.zzg).zza);
            this.zzt = zzg2;
            this.zzp = zzhk2.zzl;
            this.zzH = zzhk2.zzm;
            Looper looper = zzhk2.zzi;
            this.zzs = looper;
            zzde zzde = zzhk2.zzb;
            this.zzu = zzde;
            this.zzg = zzcg2;
            zzdt zzdt = new zzdt(looper, zzde, new zzhv(this));
            this.zzl = zzdt;
            ...
            zzdt zzdt2 = zzdt;
            zzip zzip2 = zzip;
            zzwa zzwa = new zzwa(new zzkc[2], new zzvt[2], zzcy.zza, (Object) null);
            this.zzb = zzwa;
            this.zzn = new zzck();
            zzca zzca = new zzca();
            zzdg zzdg2 = zzdg;
            ...
            zzca2.zza(10);
            this.zzI = zzca2.zze();
            this.zzj = zzde.zzb(looper, (Handler.Callback) null);
            zzhw zzhw = new zzhw(this);
            this.zzai = zzhw;
            this.zzaf = zzju.zzg(zzwa);
            apply.zzS(zzcg2, looper);
            if (zzen.zza < 31) {
                zza = new zznb();
            } else {
                zza = zzii.zza(applicationContext, this, zzhk2.zzp);
            }
            zznb zznb = zza;
            zzkd zzkd = this.zzH;
            ...
            zzdt zzdt3 = zzdt2;
            zzip zzip3 = zzip2;
            this.zzk = new zzjd(zza2, zzvz, zzwa2, (zzjh) zzhk2.zzf.zza(), zzg2, 0, false, apply, zzkd2, zzhk2.zzr, zzhk2.zzn, false, looper2, zzde, zzhw, zznb, (byte[]) null);
            this.zzX = 1.0f;
            zzbm zzbm = zzbm.zza;
            this.zzJ = zzbm;
            this.zzK = zzbm;
            ...
            if (zzen.zza < 21) {
                ...
                this.zzV = zzen.zzi(context);
            }
            this.zzZ = new zzdc(zzfvn.zzo(), 0);
            this.zzaa = true;
            Objects.requireNonNull(apply);
            zzdt3.zzb(apply);
            zzwl.zze(new Handler(looper2), apply);
            zzip zzip4 = zzip3;
            copyOnWriteArraySet3.add(zzip4);
            zzhk zzhk3 = zzhk;
            Handler handler3 = handler2;
            this.zzx = new zzgm(zzhk3.zza, handler3, zzip4);
            this.zzy = new zzgq(zzhk3.zza, handler3, zzip4);
            zzen.zzT((Object) null, (Object) null);
            zzkl zzkl = new zzkl(zzhk3.zza, handler3, zzip4);
            this.zzz = zzkl;
            int i = this.zzW.zzc;
            zzkl.zzf(3);
            this.zzA = new zzkm(zzhk3.zza);
            this.zzB = new zzkn(zzhk3.zza);
            this.zzac = zzam(zzkl);
            this.zzad = zzda.zza;
            zzvz2.zzi(this.zzW);
    ...
    public final void zzau(boolean z, int i, int i2) {
        ...
        if (zzju.zzl != z2 || zzju.zzm != i3) {
            ...
            this.zzk.zzn(z2, i3);
            zzav(zzc2, 0, i2, false, false, 5, -9223372036854775807L, -1);
        }
    }
    ...
    public final void zzW() {
        ...
        if (zzju.zze == 1) {
            ...
            this.zzD++;
            this.zzk.zzk();
            zzav(zze2, 1, 1, false, false, 5, -9223372036854775807L, -1);
        }
    }
    ...
    public final void zzX() {
        ...
        zzju zze2 = this.zzaf.zze(1);
        this.zzaf = zze2;
        zzju zza2 = zze2.zza(zze2.zzb);
        this.zzaf = zza2;
        zza2.zzp = zza2.zzr;
        this.zzaf.zzq = 0;
        this.zzr.zzQ();
    ...
    public final void zzZ(zzsk zzsk) {
        ...
        if (zzjy.zzo() || zzjy.zzc() >= 0) {
            ...
            zzju zzan = zzan(this.zzaf, zzjy, zzal(zzjy, zzg2, -9223372036854775807L));
            int i3 = zzan.zze;
            if (!(zzg2 == -1 || i3 == 1)) {
                i3 = (zzjy.zzo() || zzg2 >= zzjy.zzc()) ? 4 : 2;
            }
            zzju zze2 = zzan.zze(i3);
            this.zzk.zzq(arrayList, zzg2, zzen.zzv(-9223372036854775807L), this.zzaj);
    ...
    public final long zzk() {
        ...
        if (zzju2.zzc != -9223372036854775807L) {
