...
final class zzgqa extends zzgqe {
    ...
    public final long zzr() throws IOException {
        ...
        if (this.zzo != j4) {
            long j5 = j4 + 1;
            byte zza = zzgui.zza(j4);
            if (zza >= 0) {
                this.zzm++;
                return (long) zza;
            } else if (this.zzo - this.zzm >= 10) {
                long j6 = j5 + 1;
                byte zza2 = zza ^ (zzgui.zza(j5) << 7);
                if (zza2 < 0) {
                    b = zza2 ^ ByteCompanionObject.MIN_VALUE;
                } else {
                    long j7 = j6 + 1;
                    byte zza3 = zza2 ^ (zzgui.zza(j6) << 14);
                    if (zza3 >= 0) {
                        j = (long) (zza3 ^ ByteCompanionObject.MIN_VALUE);
                    } else {
                        j6 = j7 + 1;
                        byte zza4 = zza3 ^ (zzgui.zza(j7) << 21);
                        if (zza4 < 0) {
                            b = zza4 ^ ByteCompanionObject.MIN_VALUE;
                        } else {
                            j7 = j6 + 1;
                            long zza5 = ((long) zza4) ^ (((long) zzgui.zza(j6)) << 28);
                            if (zza5 >= 0) {
                                j3 = 266354560;
                            } else {
                                long j8 = j7 + 1;
                                long zza6 = zza5 ^ (((long) zzgui.zza(j7)) << 35);
                                if (zza6 < 0) {
                                    j2 = -34093383808L;
                                } else {
                                    j7 = j8 + 1;
                                    ...
                                    if (zza5 >= 0) {
                                        ...
                                        j8 = j7 + 1;
                                        zza6 = zza5 ^ (((long) zzgui.zza(j7)) << 49);
                                        if (zza6 < 0) {
                                            j2 = -558586000294016L;
                                        } else {
                                            j7 = j8 + 1;
                                            j = (zza6 ^ (((long) zzgui.zza(j8)) << 56)) ^ 71499008037633920L;
                                            if (j < 0) {
                                                long j9 = 1 + j7;
                                                if (((long) zzgui.zza(j7)) >= 0) {
                                                    j6 = j9;
                                                    this.zzm = j6;
                                                    return j;
                                                }
