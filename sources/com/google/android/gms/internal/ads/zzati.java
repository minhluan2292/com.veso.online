...
public final class zzati {
    ...
    public static zzasw zzb(zzbak zzbak, String str, String str2, zzauv zzauv) {
        int i = zzc[(zzbak.zzg() & 192) >> 6];
        int zzg = zzbak.zzg();
        int i2 = zzd[(zzg & 56) >> 3];
        if ((zzg & 4) != 0) {
            i2++;
        }
        return zzasw.zzg(str, "audio/ac3", (String) null, -1, -1, i2, i, (List) null, zzauv, 0, str2);
    }
    ...
    public static zzasw zzc(zzbak zzbak, String str, String str2, zzauv zzauv) {
        ...
        return zzasw.zzg(str, "audio/eac3", (String) null, -1, -1, i2, i, (List) null, zzauv, 0, str2);
    }
}
