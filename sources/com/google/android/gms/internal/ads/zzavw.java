...
class zzavw {
    ...
    public static final int zzaA = zzbar.zzg("samr");
    public static final int zzaB = zzbar.zzg("sawb");
    public static final int zzaC = zzbar.zzg("udta");
    public static final int zzaD = zzbar.zzg("meta");
    public static final int zzaE = zzbar.zzg("ilst");
    public static final int zzaF = zzbar.zzg("mean");
    public static final int zzaG = zzbar.zzg(AppMeasurementSdk.ConditionalUserProperty.NAME);
    public static final int zzaH = zzbar.zzg(Constants.ScionAnalytics.MessageType.DATA_MESSAGE);
    public static final int zzaI = zzbar.zzg("emsg");
    public static final int zzaJ = zzbar.zzg("st3d");
    public static final int zzaK = zzbar.zzg("sv3d");
    public static final int zzaL = zzbar.zzg("proj");
    public static final int zzaM = zzbar.zzg("vp08");
    public static final int zzaN = zzbar.zzg("vp09");
    public static final int zzaO = zzbar.zzg("vpcC");
    public static final int zzaP = zzbar.zzg("camm");
    public static final int zzaQ = zzbar.zzg("alac");
    ...
    public static final int zzan = zzbar.zzg("mp4v");
    public static final int zzao = zzbar.zzg("stts");
    public static final int zzap = zzbar.zzg("stss");
    public static final int zzaq = zzbar.zzg("ctts");
    public static final int zzar = zzbar.zzg("stsc");
    public static final int zzas = zzbar.zzg("stsz");
    public static final int zzat = zzbar.zzg("stz2");
    public static final int zzau = zzbar.zzg("stco");
    public static final int zzav = zzbar.zzg("co64");
    public static final int zzaw = zzbar.zzg("tx3g");
    public static final int zzax = zzbar.zzg("wvtt");
    public static final int zzay = zzbar.zzg("stpp");
    public static final int zzaz = zzbar.zzg("c608");
