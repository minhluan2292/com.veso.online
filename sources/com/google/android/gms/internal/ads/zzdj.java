...
public final class zzdj implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdj(Handler handler, zzdi zzdi) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i) throws zzdk {
        ...
        int[] iArr2 = new int[2];
        zzdl.zza(EGL14.eglInitialize(eglGetDisplay, iArr2, 0, iArr2, 1), "eglInitialize failed");
        this.zzd = eglGetDisplay;
        EGLConfig[] eGLConfigArr = new EGLConfig[1];
        int[] iArr3 = new int[1];
        boolean eglChooseConfig = EGL14.eglChooseConfig(eglGetDisplay, zza, 0, eGLConfigArr, 0, 1, iArr3, 0);
        zzdl.zza(eglChooseConfig && iArr3[0] > 0 && eGLConfigArr[0] != null, zzen.zzI("eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr3[0]), eGLConfigArr[0]));
        ...
        if (i == 1) {
            ...
            zzdl.zza(eGLSurface != null, "eglCreatePbufferSurface failed");
        }
        zzdl.zza(EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, eglCreateContext), "eglMakeCurrent failed");
        this.zzf = eGLSurface;
