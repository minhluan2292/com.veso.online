...
public final class zzckg extends zzcip implements zzbab, zzaxz, zzbbl, zzatt, zzasj {
    ...
    public zzckg(Context context, zzcix zzcix, zzciy zzciy) {
        ...
        this.zze = zzcjv;
        zzbba zzbba = new zzbba(context, zzaww.zza, 0, zzs.zza, this, -1);
        this.zzf = zzbba;
        zzaui zzaui = new zzaui(zzaww.zza, (zzauw) null, true, zzs.zza, this);
        this.zzg = zzaui;
        ...
        zza.incrementAndGet();
        int i = 0;
        zzasm zza = zzasn.zza(new zzatb[]{zzaui, zzbba}, zzayz, zzcjv);
        this.zzj = zza;
        zza.zze(this);
        this.zzo = 0;
        this.zzq = 0;
