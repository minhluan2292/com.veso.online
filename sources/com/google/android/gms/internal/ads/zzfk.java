...
public final class zzfk extends zzer implements zzfu {
    ...
    public final long zzb(com.google.android.gms.internal.ads.zzfc r25) throws com.google.android.gms.internal.ads.zzfq {
        /*
            ...
            r24.zzi(r25)
            r11 = 1
            java.net.URL r2 = new java.net.URL     // Catch:{ IOException -> 0x01f7 }
            android.net.Uri r0 = r13.zza     // Catch:{ IOException -> 0x01f7 }
            java.lang.String r0 = r0.toString()     // Catch:{ IOException -> 0x01f7 }
            r2.<init>(r0)     // Catch:{ IOException -> 0x01f7 }
            int r0 = r13.zzb     // Catch:{ IOException -> 0x01f7 }
            byte[] r0 = r13.zzc     // Catch:{ IOException -> 0x01f7 }
            long r9 = r13.zzf     // Catch:{ IOException -> 0x01f7 }
            long r7 = r13.zzg     // Catch:{ IOException -> 0x01f7 }
            boolean r0 = r13.zzb(r11)     // Catch:{ IOException -> 0x01f7 }
            boolean r1 = r12.zzb     // Catch:{ IOException -> 0x01f7 }
            r5 = 0
            if (r1 != 0) goto L_0x0045
            r3 = 1
            r4 = 0
            r16 = 1
            java.util.Map r6 = r13.zzd     // Catch:{ IOException -> 0x01f7 }
            r1 = r24
            r17 = r6
            r5 = r9
            r9 = r0
        ...
        L_0x00ee:
            ...
            java.io.InputStream r0 = r0.getInputStream()     // Catch:{ IOException -> 0x015c }
            r12.zzj = r0     // Catch:{ IOException -> 0x015c }
            if (r1 == 0) goto L_0x0101
            java.util.zip.GZIPInputStream r0 = new java.util.zip.GZIPInputStream     // Catch:{ IOException -> 0x015c }
            java.io.InputStream r1 = r12.zzj     // Catch:{ IOException -> 0x015c }
            r0.<init>(r1)     // Catch:{ IOException -> 0x015c }
            r12.zzj = r0     // Catch:{ IOException -> 0x015c }
        L_0x0101:
            r5 = 1
            r12.zzk = r5
        ...
        L_0x010c:
            ...
            byte[] r0 = new byte[r0]     // Catch:{ IOException -> 0x014b }
        L_0x0110:
            int r1 = (r8 > r14 ? 1 : (r8 == r14 ? 0 : -1))
            if (r1 <= 0) goto L_0x0148
            r6 = 4096(0x1000, double:2.0237E-320)
            long r6 = java.lang.Math.min(r8, r6)     // Catch:{ IOException -> 0x014b }
            int r1 = (int) r6     // Catch:{ IOException -> 0x014b }
            java.io.InputStream r4 = r12.zzj     // Catch:{ IOException -> 0x014b }
            int r6 = com.google.android.gms.internal.ads.zzen.zza     // Catch:{ IOException -> 0x014b }
            r6 = 0
            int r1 = r4.read(r0, r6, r1)     // Catch:{ IOException -> 0x014b }
            java.lang.Thread r4 = java.lang.Thread.currentThread()     // Catch:{ IOException -> 0x014b }
            boolean r4 = r4.isInterrupted()     // Catch:{ IOException -> 0x014b }
            if (r4 != 0) goto L_0x013d
            r4 = -1
            if (r1 == r4) goto L_0x0137
            long r10 = (long) r1     // Catch:{ IOException -> 0x014b }
            long r8 = r8 - r10
            r12.zzg(r1)     // Catch:{ IOException -> 0x014b }
            goto L_0x0110
        L_0x0137:
            com.google.android.gms.internal.ads.zzfq r0 = new com.google.android.gms.internal.ads.zzfq     // Catch:{ IOException -> 0x014b }
            r0.<init>(r13, r2, r5)     // Catch:{ IOException -> 0x014b }
            throw r0     // Catch:{ IOException -> 0x014b }
        L_0x013d:
            com.google.android.gms.internal.ads.zzfq r0 = new com.google.android.gms.internal.ads.zzfq     // Catch:{ IOException -> 0x014b }
            java.io.InterruptedIOException r1 = new java.io.InterruptedIOException     // Catch:{ IOException -> 0x014b }
            r1.<init>()     // Catch:{ IOException -> 0x014b }
            r0.<init>((java.io.IOException) r1, (com.google.android.gms.internal.ads.zzfc) r13, (int) r3, (int) r5)     // Catch:{ IOException -> 0x014b }
            throw r0     // Catch:{ IOException -> 0x014b }
        L_0x0148:
            long r0 = r12.zzm
            return r0
        ...
        L_0x018f:
            ...
            byte[] r0 = com.google.android.gms.internal.ads.zzen.zzab(r0)     // Catch:{ IOException -> 0x019e }
            goto L_0x019c
        L_0x019a:
            byte[] r0 = com.google.android.gms.internal.ads.zzen.zzf     // Catch:{ IOException -> 0x019e }
        L_0x019c:
            r7 = r0
            goto L_0x01a1
        L_0x019e:
        ...
        L_0x01bf:
            r5 = 1
            r6 = 0
            r1.disconnect()     // Catch:{ IOException -> 0x01f5 }
            r2 = r23
            java.net.URL r11 = r12.zzl(r2, r3, r13)     // Catch:{ IOException -> 0x01f5 }
            r5 = r18
            r7 = r19
            r9 = r21
            goto L_0x0047
        L_0x01d2:
            r18 = r6
            r5 = 1
            com.google.android.gms.internal.ads.zzfq r0 = new com.google.android.gms.internal.ads.zzfq     // Catch:{ IOException -> 0x01f5 }
            java.net.NoRouteToHostException r1 = new java.net.NoRouteToHostException     // Catch:{ IOException -> 0x01f5 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x01f5 }
            r2.<init>()     // Catch:{ IOException -> 0x01f5 }
            java.lang.String r3 = "Too many redirects: "
            r2.append(r3)     // Catch:{ IOException -> 0x01f5 }
            r3 = r18
            r2.append(r3)     // Catch:{ IOException -> 0x01f5 }
            java.lang.String r2 = r2.toString()     // Catch:{ IOException -> 0x01f5 }
            r1.<init>(r2)     // Catch:{ IOException -> 0x01f5 }
            r2 = 2001(0x7d1, float:2.804E-42)
            r0.<init>((java.io.IOException) r1, (com.google.android.gms.internal.ads.zzfc) r13, (int) r2, (int) r5)     // Catch:{ IOException -> 0x01f5 }
    ...
    /* JADX WARNING: Can't wrap try/catch for region: R(6:4|(1:6)(1:7)|8|(3:10|11|(5:13|14|(2:16|(1:18))(2:19|(1:21))|22|(4:26|27|28|29)))|30|31) */
    ...
    public final void zzd() throws com.google.android.gms.internal.ads.zzfq {
        /*
            ...
            r0 = 0
            r1 = 0
            java.io.InputStream r2 = r10.zzj     // Catch:{ all -> 0x008c }
            if (r2 == 0) goto L_0x007d
            long r3 = r10.zzm     // Catch:{ all -> 0x008c }
            r5 = -1
            ...
            goto L_0x0013
        L_0x0010:
            long r7 = r10.zzn     // Catch:{ all -> 0x008c }
            long r3 = r3 - r7
        L_0x0013:
            java.net.HttpURLConnection r7 = r10.zzi     // Catch:{ all -> 0x008c }
            if (r7 == 0) goto L_0x006b
            int r8 = com.google.android.gms.internal.ads.zzen.zza     // Catch:{ all -> 0x008c }
            int r8 = com.google.android.gms.internal.ads.zzen.zza     // Catch:{ all -> 0x008c }
            r9 = 20
            if (r8 <= r9) goto L_0x0020
            goto L_0x006b
        L_0x0020:
            java.io.InputStream r7 = r7.getInputStream()     // Catch:{ Exception -> 0x006b }
            int r5 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r5 != 0) goto L_0x0030
            int r3 = r7.read()     // Catch:{ Exception -> 0x006b }
            r4 = -1
        ...
        L_0x0030:
            ...
            goto L_0x006b
        L_0x0037:
            java.lang.Class r3 = r7.getClass()     // Catch:{ Exception -> 0x006b }
            java.lang.String r3 = r3.getName()     // Catch:{ Exception -> 0x006b }
            java.lang.String r4 = "com.android.okhttp.internal.http.HttpTransport$ChunkedInputStream"
            boolean r4 = r4.equals(r3)     // Catch:{ Exception -> 0x006b }
            if (r4 != 0) goto L_0x004f
            java.lang.String r4 = "com.android.okhttp.internal.http.HttpTransport$FixedLengthInputStream"
            boolean r3 = r4.equals(r3)     // Catch:{ Exception -> 0x006b }
        ...
        L_0x004f:
            ...
            r3.invoke(r7, r4)     // Catch:{ Exception -> 0x006b }
        L_0x006b:
            r2.close()     // Catch:{ IOException -> 0x006f }
            goto L_0x007d
        L_0x006f:
            r2 = move-exception
            com.google.android.gms.internal.ads.zzfq r3 = new com.google.android.gms.internal.ads.zzfq     // Catch:{ all -> 0x008c }
            com.google.android.gms.internal.ads.zzfc r4 = r10.zzh     // Catch:{ all -> 0x008c }
            int r5 = com.google.android.gms.internal.ads.zzen.zza     // Catch:{ all -> 0x008c }
            r5 = 2000(0x7d0, float:2.803E-42)
            r6 = 3
            r3.<init>((java.io.IOException) r2, (com.google.android.gms.internal.ads.zzfc) r4, (int) r5, (int) r6)     // Catch:{ all -> 0x008c }
