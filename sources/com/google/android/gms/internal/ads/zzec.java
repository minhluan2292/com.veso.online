...
final class zzec extends BroadcastReceiver {
    ...
    public final void onReceive(android.content.Context r9, android.content.Intent r10) {
        ...
        L_0x004e:
            ...
            java.lang.Object r0 = r9.getSystemService(r0)     // Catch:{ RuntimeException -> 0x0073 }
            android.telephony.TelephonyManager r0 = (android.telephony.TelephonyManager) r0     // Catch:{ RuntimeException -> 0x0073 }
            java.util.Objects.requireNonNull(r0)
            com.google.android.gms.internal.ads.zzea r1 = new com.google.android.gms.internal.ads.zzea     // Catch:{ RuntimeException -> 0x0073 }
            r1.<init>(r10)     // Catch:{ RuntimeException -> 0x0073 }
            java.util.concurrent.Executor r9 = r9.getMainExecutor()     // Catch:{ RuntimeException -> 0x0073 }
            r0.registerTelephonyCallback(r9, r1)     // Catch:{ RuntimeException -> 0x0073 }
            r0.unregisterTelephonyCallback(r1)     // Catch:{ RuntimeException -> 0x0073 }
            return
        L_0x0073:
