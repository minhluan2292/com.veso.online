...
public final class zzcvg implements zzbud {
    ...
    public final JSONObject zzb(zzcvj zzcvj) throws JSONException {
        ...
        if (zzbbp == null) {
            ...
            jSONObject3.put("windowVisibility", zzbbp.zzb).put("isAttachedToWindow", z2).put("viewBox", new JSONObject().put("top", zzbbp.zzc.top).put("bottom", zzbbp.zzc.bottom).put("left", zzbbp.zzc.left).put("right", zzbbp.zzc.right)).put("adBox", new JSONObject().put("top", zzbbp.zzd.top).put("bottom", zzbbp.zzd.bottom).put("left", zzbbp.zzd.left).put("right", zzbbp.zzd.right)).put("globalVisibleBox", new JSONObject().put("top", zzbbp.zze.top).put("bottom", zzbbp.zze.bottom).put("left", zzbbp.zze.left).put("right", zzbbp.zze.right)).put("globalVisibleBoxVisible", zzbbp.zzf).put("localVisibleBox", new JSONObject().put("top", zzbbp.zzg.top).put("bottom", zzbbp.zzg.bottom).put("left", zzbbp.zzg.left).put("right", zzbbp.zzg.right)).put("localVisibleBoxVisible", zzbbp.zzh).put("hitBox", new JSONObject().put("top", zzbbp.zzi.top).put("bottom", zzbbp.zzi.bottom).put("left", zzbbp.zzi.left).put("right", zzbbp.zzi.right)).put("screenDensity", (double) this.zza.getResources().getDisplayMetrics().density);
