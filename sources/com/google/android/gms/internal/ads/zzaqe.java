...
public final class zzaqe {
    private static final String zzd = "zzaqe";
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x0058 A[Catch:{ zzapv -> 0x0165 }] */
    /* JADX WARNING: Removed duplicated region for block: B:30:0x0086 A[Catch:{ IllegalArgumentException -> 0x0157, zzapj -> 0x015e }] */
    ...
    public static com.google.android.gms.internal.ads.zzaqe zzg(android.content.Context r9, java.lang.String r10, java.lang.String r11, boolean r12) {
        /*
            ...
            r0.<init>(r9)
            com.google.android.gms.internal.ads.zzaqa r9 = new com.google.android.gms.internal.ads.zzaqa     // Catch:{ zzapv -> 0x0165 }
            r9.<init>()     // Catch:{ zzapv -> 0x0165 }
            java.util.concurrent.ExecutorService r9 = java.util.concurrent.Executors.newCachedThreadPool(r9)     // Catch:{ zzapv -> 0x0165 }
            r0.zze = r9     // Catch:{ zzapv -> 0x0165 }
            r0.zzj = r12     // Catch:{ zzapv -> 0x0165 }
            if (r12 == 0) goto L_0x0025
            java.util.concurrent.ExecutorService r9 = r0.zze     // Catch:{ zzapv -> 0x0165 }
            com.google.android.gms.internal.ads.zzaqb r12 = new com.google.android.gms.internal.ads.zzaqb     // Catch:{ zzapv -> 0x0165 }
            r12.<init>(r0)     // Catch:{ zzapv -> 0x0165 }
            java.util.concurrent.Future r9 = r9.submit(r12)     // Catch:{ zzapv -> 0x0165 }
            r0.zzk = r9     // Catch:{ zzapv -> 0x0165 }
        L_0x0025:
            java.util.concurrent.ExecutorService r9 = r0.zze     // Catch:{ zzapv -> 0x0165 }
            com.google.android.gms.internal.ads.zzaqd r12 = new com.google.android.gms.internal.ads.zzaqd     // Catch:{ zzapv -> 0x0165 }
            r12.<init>(r0)     // Catch:{ zzapv -> 0x0165 }
            r9.execute(r12)     // Catch:{ zzapv -> 0x0165 }
            r9 = 1
            r12 = 0
        ...
        L_0x004f:
            r0.zzo(r12, r9)     // Catch:{ zzapv -> 0x0165 }
            boolean r1 = com.google.android.gms.internal.ads.zzaqh.zzf()     // Catch:{ zzapv -> 0x0165 }
            if (r1 == 0) goto L_0x0073
            com.google.android.gms.internal.ads.zzbiu r1 = com.google.android.gms.internal.ads.zzbjc.zzcx     // Catch:{ zzapv -> 0x0165 }
            com.google.android.gms.internal.ads.zzbja r2 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ zzapv -> 0x0165 }
            java.lang.Object r1 = r2.zzb(r1)     // Catch:{ zzapv -> 0x0165 }
            java.lang.Boolean r1 = (java.lang.Boolean) r1     // Catch:{ zzapv -> 0x0165 }
            boolean r1 = r1.booleanValue()     // Catch:{ zzapv -> 0x0165 }
            if (r1 != 0) goto L_0x006b
            goto L_0x0073
        L_0x006b:
            java.lang.IllegalStateException r9 = new java.lang.IllegalStateException     // Catch:{ zzapv -> 0x0165 }
            java.lang.String r10 = "Task Context initialization must not be called from the UI thread."
            r9.<init>(r10)     // Catch:{ zzapv -> 0x0165 }
            throw r9     // Catch:{ zzapv -> 0x0165 }
        L_0x0073:
            com.google.android.gms.internal.ads.zzapk r1 = new com.google.android.gms.internal.ads.zzapk     // Catch:{ zzapv -> 0x0165 }
            r2 = 0
            r1.<init>(r2)     // Catch:{ zzapv -> 0x0165 }
            r0.zzg = r1     // Catch:{ zzapv -> 0x0165 }
            java.lang.String r3 = "HeBkX9XaSpC6sV82I6X2HUgm82vH8VhIWt26LGkrI3A="
            byte[] r3 = com.google.android.gms.internal.ads.zzanp.zzb(r3, r12)     // Catch:{ IllegalArgumentException -> 0x0157 }
        ...
        L_0x0093:
            ...
            goto L_0x0093
        L_0x009f:
            r0.zzh = r4     // Catch:{ zzapj -> 0x015e }
            android.content.Context r1 = r0.zza     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            java.io.File r1 = r1.getCacheDir()     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            if (r1 != 0) goto L_0x00ba
            android.content.Context r1 = r0.zza     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            java.lang.String r3 = "dex"
            java.io.File r1 = r1.getDir(r3, r12)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            if (r1 == 0) goto L_0x00b4
            goto L_0x00ba
        L_0x00b4:
            com.google.android.gms.internal.ads.zzapv r9 = new com.google.android.gms.internal.ads.zzapv     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r9.<init>()     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            throw r9     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
        L_0x00ba:
            ...
            java.io.File r4 = new java.io.File     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r5 = 2
            java.lang.Object[] r6 = new java.lang.Object[r5]     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r6[r12] = r1     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r6[r9] = r11     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            java.lang.String r7 = "%s/%s.jar"
            java.lang.String r6 = java.lang.String.format(r7, r6)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r4.<init>(r6)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            boolean r6 = r4.exists()     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            if (r6 != 0) goto L_0x00eb
            com.google.android.gms.internal.ads.zzapk r6 = r0.zzg     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            byte[] r7 = r0.zzh     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            byte[] r3 = r6.zzb(r7, r3)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r4.createNewFile()     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            java.io.FileOutputStream r6 = new java.io.FileOutputStream     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r6.<init>(r4)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            int r7 = r3.length     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r6.write(r3, r12, r7)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r6.close()     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
        L_0x00eb:
            r0.zzx(r1, r11)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            ...
            zzy(r4)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r0.zzw(r1, r11)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            java.lang.Object[] r2 = new java.lang.Object[r5]     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r2[r12] = r1     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r2[r9] = r11     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            java.lang.String r10 = java.lang.String.format(r10, r2)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            zzz(r10)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            com.google.android.gms.internal.ads.zzaoz r10 = new com.google.android.gms.internal.ads.zzaoz     // Catch:{ zzapv -> 0x0165 }
            r10.<init>(r0)     // Catch:{ zzapv -> 0x0165 }
            r0.zzo = r10     // Catch:{ zzapv -> 0x0165 }
            r0.zzq = r9     // Catch:{ zzapv -> 0x0165 }
            goto L_0x0165
        L_0x0120:
            r2 = move-exception
            zzy(r4)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r0.zzw(r1, r11)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            java.lang.Object[] r3 = new java.lang.Object[r5]     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r3[r12] = r1     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            r3[r9] = r11     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            java.lang.String r9 = java.lang.String.format(r10, r3)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            zzz(r9)     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
            throw r2     // Catch:{ FileNotFoundException -> 0x014a, IOException -> 0x0143, zzapj -> 0x013c, NullPointerException -> 0x0135 }
        L_0x0135:
            r9 = move-exception
            com.google.android.gms.internal.ads.zzapv r10 = new com.google.android.gms.internal.ads.zzapv     // Catch:{ zzapv -> 0x0165 }
            r10.<init>(r9)     // Catch:{ zzapv -> 0x0165 }
            throw r10     // Catch:{ zzapv -> 0x0165 }
        L_0x013c:
            r9 = move-exception
            com.google.android.gms.internal.ads.zzapv r10 = new com.google.android.gms.internal.ads.zzapv     // Catch:{ zzapv -> 0x0165 }
            r10.<init>(r9)     // Catch:{ zzapv -> 0x0165 }
        ...
        L_0x014a:
            ...
            throw r10     // Catch:{ zzapv -> 0x0165 }
        L_0x0151:
            com.google.android.gms.internal.ads.zzapj r9 = new com.google.android.gms.internal.ads.zzapj     // Catch:{ IllegalArgumentException -> 0x0157 }
            r9.<init>(r1)     // Catch:{ IllegalArgumentException -> 0x0157 }
            throw r9     // Catch:{ IllegalArgumentException -> 0x0157 }
        L_0x0157:
            r9 = move-exception
            com.google.android.gms.internal.ads.zzapj r10 = new com.google.android.gms.internal.ads.zzapj     // Catch:{ zzapj -> 0x015e }
            r10.<init>(r1, r9)     // Catch:{ zzapj -> 0x015e }
            throw r10     // Catch:{ zzapj -> 0x015e }
        L_0x015e:
            r9 = move-exception
            com.google.android.gms.internal.ads.zzapv r10 = new com.google.android.gms.internal.ads.zzapv     // Catch:{ zzapv -> 0x0165 }
            r10.<init>(r9)     // Catch:{ zzapv -> 0x0165 }
    ...
    private final void zzw(java.io.File r11, java.lang.String r12) {
        ...
        L_0x0042:
            ...
            r1 = 0
            java.io.FileInputStream r4 = new java.io.FileInputStream     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00df, all -> 0x00ce }
            r4.<init>(r2)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00df, all -> 0x00ce }
            int r6 = r4.read(r11)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
        ...
        L_0x0054:
            ...
            return
        L_0x0058:
            java.io.PrintStream r6 = java.lang.System.out     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            r6.print(r12)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            java.io.PrintStream r6 = java.lang.System.out     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            r6.print(r12)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            java.io.PrintStream r6 = java.lang.System.out     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            r6.print(r12)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            com.google.android.gms.internal.ads.zzand r12 = com.google.android.gms.internal.ads.zzane.zza()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            java.lang.String r6 = android.os.Build.VERSION.SDK     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            byte[] r6 = r6.getBytes()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            com.google.android.gms.internal.ads.zzgpw r6 = com.google.android.gms.internal.ads.zzgpw.zzv(r6)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            r12.zzc(r6)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            byte[] r5 = r5.getBytes()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            com.google.android.gms.internal.ads.zzgpw r5 = com.google.android.gms.internal.ads.zzgpw.zzv(r5)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            r12.zzd(r5)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            com.google.android.gms.internal.ads.zzapk r5 = r10.zzg     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            byte[] r6 = r10.zzh     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            java.lang.String r11 = r5.zza(r6, r11)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            byte[] r11 = r11.getBytes()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            com.google.android.gms.internal.ads.zzgpw r5 = com.google.android.gms.internal.ads.zzgpw.zzv(r11)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            r12.zza(r5)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            byte[] r11 = com.google.android.gms.internal.ads.zzant.zze(r11)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            com.google.android.gms.internal.ads.zzgpw r11 = com.google.android.gms.internal.ads.zzgpw.zzv(r11)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            r12.zzb(r11)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            r0.createNewFile()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            java.io.FileOutputStream r11 = new java.io.FileOutputStream     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            r11.<init>(r0)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cb, all -> 0x00c6 }
            com.google.android.gms.internal.ads.zzgre r12 = r12.zzam()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cc, all -> 0x00c4 }
            com.google.android.gms.internal.ads.zzane r12 = (com.google.android.gms.internal.ads.zzane) r12     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cc, all -> 0x00c4 }
            byte[] r12 = r12.zzax()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cc, all -> 0x00c4 }
            int r0 = r12.length     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cc, all -> 0x00c4 }
            r11.write(r12, r3, r0)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cc, all -> 0x00c4 }
            r11.close()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00cc, all -> 0x00c4 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:55:? A[ExcHandler: zzapj | IOException | NoSuchAlgorithmException (unused java.lang.Throwable), SYNTHETIC, Splitter:B:12:0x004b] */
    ...
    private final boolean zzx(java.io.File r10, java.lang.String r11) {
        ...
        L_0x001d:
            ...
            r10 = 0
            long r5 = r11.length()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00f3, all -> 0x00e6 }
            r7 = 0
            int r0 = (r5 > r7 ? 1 : (r5 == r7 ? 0 : -1))
            if (r0 > 0) goto L_0x0043
            zzy(r11)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00f3, all -> 0x00e6 }
            return r2
        L_0x0043:
            int r0 = (int) r5     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00f3, all -> 0x00e6 }
            byte[] r0 = new byte[r0]     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00f3, all -> 0x00e6 }
            java.io.FileInputStream r5 = new java.io.FileInputStream     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00f3, all -> 0x00e6 }
            r5.<init>(r11)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00f3, all -> 0x00e6 }
            int r6 = r5.read(r0)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            if (r6 > 0) goto L_0x005f
            java.lang.String r0 = zzd     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            java.lang.String r1 = "Cannot read the cache data."
            android.util.Log.d(r0, r1)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            zzy(r11)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            r5.close()     // Catch:{ IOException -> 0x005e }
        L_0x005e:
            return r2
        L_0x005f:
            com.google.android.gms.internal.ads.zzgqq r6 = com.google.android.gms.internal.ads.zzgqq.zza()     // Catch:{ NullPointerException -> 0x00db, zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, zzapj | IOException | NoSuchAlgorithmException -> 0x00e3 }
            com.google.android.gms.internal.ads.zzane r0 = com.google.android.gms.internal.ads.zzane.zzd(r0, r6)     // Catch:{ NullPointerException -> 0x00db, zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, zzapj | IOException | NoSuchAlgorithmException -> 0x00e3 }
            java.lang.String r6 = new java.lang.String     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            com.google.android.gms.internal.ads.zzgpw r7 = r0.zzh()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            byte[] r7 = r7.zzE()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            r6.<init>(r7)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            boolean r4 = r4.equals(r6)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            if (r4 == 0) goto L_0x00d4
            com.google.android.gms.internal.ads.zzgpw r4 = r0.zzf()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            byte[] r4 = r4.zzE()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            com.google.android.gms.internal.ads.zzgpw r6 = r0.zze()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            byte[] r6 = r6.zzE()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            byte[] r6 = com.google.android.gms.internal.ads.zzant.zze(r6)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            boolean r4 = java.util.Arrays.equals(r4, r6)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            if (r4 == 0) goto L_0x00d4
            com.google.android.gms.internal.ads.zzgpw r4 = r0.zzg()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            byte[] r4 = r4.zzE()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            java.lang.String r6 = android.os.Build.VERSION.SDK     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            byte[] r6 = r6.getBytes()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            boolean r4 = java.util.Arrays.equals(r4, r6)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            if (r4 != 0) goto L_0x00a9
            goto L_0x00d4
        L_0x00a9:
            com.google.android.gms.internal.ads.zzapk r11 = r9.zzg     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            byte[] r4 = r9.zzh     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            java.lang.String r6 = new java.lang.String     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            com.google.android.gms.internal.ads.zzgpw r0 = r0.zze()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            byte[] r0 = r0.zzE()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            r6.<init>(r0)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            byte[] r11 = r11.zzb(r4, r6)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            r1.createNewFile()     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            java.io.FileOutputStream r0 = new java.io.FileOutputStream     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            r0.<init>(r1)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e3, all -> 0x00df }
            int r10 = r11.length     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e4, all -> 0x00d1 }
            r0.write(r11, r2, r10)     // Catch:{ zzapj | IOException | NoSuchAlgorithmException -> 0x00e4, all -> 0x00d1 }
