...
public final class zzclk extends zzclb implements zzcio {
    ...
    public final boolean zzr(java.lang.String r46, java.lang.String[] r47) {
        /*
            ...
            r18 = 0
            int r1 = r0.length     // Catch:{ Exception -> 0x01cb }
            android.net.Uri[] r1 = new android.net.Uri[r1]     // Catch:{ Exception -> 0x01cb }
            r2 = r18
        L_0x0015:
            int r3 = r0.length     // Catch:{ Exception -> 0x01cb }
            if (r2 >= r3) goto L_0x0023
            r3 = r0[r2]     // Catch:{ Exception -> 0x01cb }
            android.net.Uri r3 = android.net.Uri.parse(r3)     // Catch:{ Exception -> 0x01cb }
            r1[r2] = r3     // Catch:{ Exception -> 0x01cb }
            int r2 = r2 + 1
            goto L_0x0015
        L_0x0023:
            com.google.android.gms.internal.ads.zzcip r0 = r15.zze     // Catch:{ Exception -> 0x01cb }
            java.lang.String r2 = r15.zzb     // Catch:{ Exception -> 0x01cb }
            r0.zzC(r1, r2)     // Catch:{ Exception -> 0x01cb }
            java.lang.ref.WeakReference r0 = r15.zzc     // Catch:{ Exception -> 0x01cb }
            java.lang.Object r0 = r0.get()     // Catch:{ Exception -> 0x01cb }
            com.google.android.gms.internal.ads.zzciy r0 = (com.google.android.gms.internal.ads.zzciy) r0     // Catch:{ Exception -> 0x01cb }
            if (r0 == 0) goto L_0x0037
            r0.zzv(r14, r15)     // Catch:{ Exception -> 0x01cb }
        L_0x0037:
            com.google.android.gms.common.util.Clock r0 = com.google.android.gms.ads.internal.zzt.zzB()     // Catch:{ Exception -> 0x01cb }
            long r19 = r0.currentTimeMillis()     // Catch:{ Exception -> 0x01cb }
            com.google.android.gms.internal.ads.zzbiu r1 = com.google.android.gms.internal.ads.zzbjc.zzw     // Catch:{ Exception -> 0x01cb }
            com.google.android.gms.internal.ads.zzbja r2 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ Exception -> 0x01cb }
            java.lang.Object r1 = r2.zzb(r1)     // Catch:{ Exception -> 0x01cb }
            java.lang.Long r1 = (java.lang.Long) r1     // Catch:{ Exception -> 0x01cb }
            long r11 = r1.longValue()     // Catch:{ Exception -> 0x01cb }
            com.google.android.gms.internal.ads.zzbiu r1 = com.google.android.gms.internal.ads.zzbjc.zzv     // Catch:{ Exception -> 0x01cb }
            com.google.android.gms.internal.ads.zzbja r2 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ Exception -> 0x01cb }
            java.lang.Object r1 = r2.zzb(r1)     // Catch:{ Exception -> 0x01cb }
            java.lang.Long r1 = (java.lang.Long) r1     // Catch:{ Exception -> 0x01cb }
            long r1 = r1.longValue()     // Catch:{ Exception -> 0x01cb }
            r3 = 1000(0x3e8, double:4.94E-321)
            long r9 = r1 * r3
            com.google.android.gms.internal.ads.zzbiu r1 = com.google.android.gms.internal.ads.zzbjc.zzu     // Catch:{ Exception -> 0x01cb }
            com.google.android.gms.internal.ads.zzbja r2 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ Exception -> 0x01cb }
            java.lang.Object r1 = r2.zzb(r1)     // Catch:{ Exception -> 0x01cb }
            java.lang.Integer r1 = (java.lang.Integer) r1     // Catch:{ Exception -> 0x01cb }
            int r1 = r1.intValue()     // Catch:{ Exception -> 0x01cb }
            long r6 = (long) r1     // Catch:{ Exception -> 0x01cb }
            com.google.android.gms.internal.ads.zzbiu r1 = com.google.android.gms.internal.ads.zzbjc.zzbD     // Catch:{ Exception -> 0x01cb }
            com.google.android.gms.internal.ads.zzbja r2 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ Exception -> 0x01cb }
            java.lang.Object r1 = r2.zzb(r1)     // Catch:{ Exception -> 0x01cb }
            java.lang.Boolean r1 = (java.lang.Boolean) r1     // Catch:{ Exception -> 0x01cb }
            boolean r21 = r1.booleanValue()     // Catch:{ Exception -> 0x01cb }
            r22 = -1
            r1 = r22
        L_0x0088:
            monitor-enter(r45)     // Catch:{ Exception -> 0x01cb }
            long r3 = r0.currentTimeMillis()     // Catch:{ all -> 0x01c3 }
            long r3 = r3 - r19
            int r3 = (r3 > r9 ? 1 : (r3 == r9 ? 0 : -1))
            if (r3 > 0) goto L_0x0198
            boolean r3 = r15.zzg     // Catch:{ all -> 0x01c3 }
            if (r3 != 0) goto L_0x018b
            boolean r3 = r15.zzh     // Catch:{ all -> 0x01c3 }
            r24 = 1
            ...
            goto L_0x015a
        L_0x00a1:
            com.google.android.gms.internal.ads.zzcip r3 = r15.zze     // Catch:{ all -> 0x01c3 }
            boolean r3 = r3.zzR()     // Catch:{ all -> 0x01c3 }
            if (r3 == 0) goto L_0x017e
            com.google.android.gms.internal.ads.zzcip r3 = r15.zze     // Catch:{ all -> 0x01c3 }
            long r4 = r3.zzz()     // Catch:{ all -> 0x01c3 }
            r25 = 0
            int r3 = (r4 > r25 ? 1 : (r4 == r25 ? 0 : -1))
            if (r3 <= 0) goto L_0x015e
            com.google.android.gms.internal.ads.zzcip r3 = r15.zze     // Catch:{ all -> 0x01c3 }
            long r27 = r3.zzv()     // Catch:{ all -> 0x01c3 }
        ...
        L_0x00c8:
            ...
            com.google.android.gms.internal.ads.zzcip r1 = r15.zze     // Catch:{ all -> 0x01c3 }
            long r1 = r1.zzA()     // Catch:{ all -> 0x01c3 }
            r29 = r1
            goto L_0x00d5
        L_0x00d3:
            r29 = r22
        L_0x00d5:
            ...
            com.google.android.gms.internal.ads.zzcip r1 = r15.zze     // Catch:{ all -> 0x01c3 }
            long r1 = r1.zzx()     // Catch:{ all -> 0x01c3 }
            r31 = r1
            goto L_0x00e2
        L_0x00e0:
            r31 = r22
        L_0x00e2:
            ...
            com.google.android.gms.internal.ads.zzcip r1 = r15.zze     // Catch:{ all -> 0x01c3 }
            long r1 = r1.zzB()     // Catch:{ all -> 0x01c3 }
            r33 = r1
            goto L_0x00ef
        L_0x00ed:
            r33 = r22
        ...
        L_0x0136:
            ...
            r6 = r46
            r7 = r44
            r5.zze(r6, r7, r3)     // Catch:{ all -> 0x01c1 }
            monitor-exit(r45)     // Catch:{ all -> 0x01c1 }
            goto L_0x015a
        L_0x0145:
            r5 = r45
            r6 = r46
            r7 = r44
            com.google.android.gms.internal.ads.zzcip r3 = r5.zze     // Catch:{ all -> 0x01c1 }
            long r3 = r3.zzw()     // Catch:{ all -> 0x01c1 }
        ...
        L_0x0198:
            ...
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x01bd }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x01bd }
            ...
            r2.append(r3)     // Catch:{ all -> 0x01bd }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x01bd }
            r0.<init>(r2)     // Catch:{ all -> 0x01bd }
            throw r0     // Catch:{ all -> 0x01bd }
        L_0x01bd:
            r0 = move-exception
    ...
    public final boolean zzs(String str, String[] strArr, zzckt zzckt) {
        ...
        try {
            ...
            release();
            zzc(str, zzu, Constants.IPC_BUNDLE_KEY_SEND_ERROR, zzw(Constants.IPC_BUNDLE_KEY_SEND_ERROR, e));
            return false;
        }
    }
