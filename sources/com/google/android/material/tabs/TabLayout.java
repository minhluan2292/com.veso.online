...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        ...
        L_0x007d:
            ...
            int r0 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x01ba }
            int r0 = r13.getDimensionPixelSize(r0, r11)     // Catch:{ all -> 0x01ba }
            float r0 = (float) r0     // Catch:{ all -> 0x01ba }
            r10.tabTextSize = r0     // Catch:{ all -> 0x01ba }
            int r0 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x01ba }
            android.content.res.ColorStateList r0 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r7, (android.content.res.TypedArray) r13, (int) r0)     // Catch:{ all -> 0x01ba }
            r10.tabTextColors = r0     // Catch:{ all -> 0x01ba }
            r13.recycle()
