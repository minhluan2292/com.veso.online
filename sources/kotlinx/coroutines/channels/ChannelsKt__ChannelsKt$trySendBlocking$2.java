    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m599constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m599constructorimpl(Unit.INSTANCE);
        if (Result.m606isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m420successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m418closedJP2dKIU(Result.m602exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m405boximpl(obj3);
    }
}
