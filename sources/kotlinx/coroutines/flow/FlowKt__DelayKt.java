...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m432debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m385toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m433sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m385toDelayMillisLRDsOJo(j));
    }
}
