...
public final class DelayKt {
    ...
    public static final Object m384delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m385toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m385toDelayMillisLRDsOJo(long j) {
        if (Duration.m219compareToLRDsOJo(j, Duration.Companion.m322getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m238getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
